...
public class CalendarEventPersistenceImpl extends BasePersistenceImpl<CalendarEvent>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(CalendarEventModelImpl.ENTITY_CACHE_ENABLED,
			CalendarEventModelImpl.FINDER_CACHE_ENABLED,
			CalendarEventImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByUuid_C",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(CalendarEventModelImpl.ENTITY_CACHE_ENABLED,
			CalendarEventModelImpl.FINDER_CACHE_ENABLED,
			CalendarEventImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() },
			CalendarEventModelImpl.UUID_COLUMN_BITMASK |
			CalendarEventModelImpl.COMPANYID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_C = new FinderPath(CalendarEventModelImpl.ENTITY_CACHE_ENABLED,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID_G = new FinderPath(CalendarEventModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { String.class.getName(), Long.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(CalendarEventModelImpl.ENTITY_CACHE_ENABLED,
			CalendarEventModelImpl.FINDER_CACHE_ENABLED,
			CalendarEventImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(CalendarEventModelImpl.ENTITY_CACHE_ENABLED,
			CalendarEventModelImpl.FINDER_CACHE_ENABLED,
			CalendarEventImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);
		...
		if (isNew || !CalendarEventModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((calendarEventModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						...
						Long.valueOf(calendarEventModelImpl.getOriginalCompanyId())
					};
				...
				args = new Object[] {
						...
						Long.valueOf(calendarEventModelImpl.getCompanyId())
					};
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CalendarEvent> findByUuid_C(String uuid, long companyId)
		throws SystemException {
		...
		if ((list != null) && !list.isEmpty()) {
			for (CalendarEvent calendarEvent : list) {
				if (!Validator.equals(uuid, calendarEvent.getUuid()) ||
						(companyId != calendarEvent.getCompanyId())) {
					list = null;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CalendarEvent findByUuid_C_First(String uuid, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchEventException, SystemException {
		List<CalendarEvent> list = findByUuid_C(uuid, companyId, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CalendarEvent findByUuid_C_Last(String uuid, long companyId,
		OrderByComparator orderByComparator)
		throws NoSuchEventException, SystemException {
		int count = countByUuid_C(uuid, companyId);

		List<CalendarEvent> list = findByUuid_C(uuid, companyId, count - 1,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CalendarEvent[] findByUuid_C_PrevAndNext(long calendarEventId,
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, calendarEvent, uuid,
					companyId, orderByComparator, true);

			array[1] = calendarEvent;

			array[2] = getByUuid_C_PrevAndNext(session, calendarEvent, uuid,
	...
	protected CalendarEvent getByUuid_C_PrevAndNext(Session session,
		CalendarEvent calendarEvent, String uuid, long companyId,
		...
		if (orderByComparator != null) {
			Object[] values = orderByComparator.getOrderByConditionValues(calendarEvent);
	...
	public void removeByUuid_C(String uuid, long companyId)
		throws SystemException {
		for (CalendarEvent calendarEvent : findByUuid_C(uuid, companyId)) {
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_1 = "calendarEvent.uuid IS NULL AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_2 = "calendarEvent.uuid = ? AND ";
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(calendarEvent.uuid IS NULL OR calendarEvent.uuid = ?) AND ";
	private static final String _FINDER_COLUMN_UUID_C_COMPANYID_2 = "calendarEvent.companyId = ?";
