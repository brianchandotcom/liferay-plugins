...
public class CalendarBookingPersistenceImpl extends BasePersistenceImpl<CalendarBooking>
	...
	/**
	 * Returns the first calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where uuid = &#63;.
	 *
	 * @param uuid the uuid
	...
	/**
	 * Returns the last calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where uuid = &#63;.
	 *
	 * @param uuid the uuid
	...
	/**
	 * Returns the first calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @return the first matching calendar booking
	...
	/**
	 * Returns the last calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @return the last matching calendar booking
	...
	/**
	 * Returns the first calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where calendarId = &#63;.
	 *
	 * @param calendarId the calendar ID
	 * @return the first matching calendar booking
	 * @throws com.liferay.calendar.NoSuchBookingException if a matching calendar booking could not be found
	...
	public CalendarBooking findByCalendarId_First(long calendarId)
		throws NoSuchBookingException, SystemException {
		return findByCalendarId_First(calendarId, null);
	}
	...
	public CalendarBooking fetchByCalendarId_First(long calendarId)
		throws SystemException {
		return fetchByCalendarId_First(calendarId, null);
	}
	...
	/**
	 * Returns the last calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where calendarId = &#63;.
	 *
	 * @param calendarId the calendar ID
	 * @return the last matching calendar booking
	 * @throws com.liferay.calendar.NoSuchBookingException if a matching calendar booking could not be found
	...
	public CalendarBooking findByCalendarId_Last(long calendarId)
		throws NoSuchBookingException, SystemException {
		return findByCalendarId_Last(calendarId, null);
	}
	...
	public CalendarBooking fetchByCalendarId_Last(long calendarId)
		throws SystemException {
		return fetchByCalendarId_Last(calendarId, null);
	}
	...
	/**
	 * Returns the first calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where calendarResourceId = &#63;.
	 *
	 * @param calendarResourceId the calendar resource ID
	 * @return the first matching calendar booking
	 * @throws com.liferay.calendar.NoSuchBookingException if a matching calendar booking could not be found
	...
	public CalendarBooking findByCalendarResourceId_First(
		long calendarResourceId) throws NoSuchBookingException, SystemException {
		return findByCalendarResourceId_First(calendarResourceId, null);
	}
	...
	public CalendarBooking fetchByCalendarResourceId_First(
		long calendarResourceId) throws SystemException {
		return fetchByCalendarResourceId_First(calendarResourceId, null);
	}
	...
	/**
	 * Returns the last calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where calendarResourceId = &#63;.
	 *
	 * @param calendarResourceId the calendar resource ID
	 * @return the last matching calendar booking
	 * @throws com.liferay.calendar.NoSuchBookingException if a matching calendar booking could not be found
	...
	public CalendarBooking findByCalendarResourceId_Last(
		long calendarResourceId) throws NoSuchBookingException, SystemException {
		return findByCalendarResourceId_Last(calendarResourceId, null);
	}
	...
	public CalendarBooking fetchByCalendarResourceId_Last(
		long calendarResourceId) throws SystemException {
		return fetchByCalendarResourceId_Last(calendarResourceId, null);
	}
	...
	/**
	 * Returns the first calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where parentCalendarBookingId = &#63;.
	 *
	 * @param parentCalendarBookingId the parent calendar booking ID
	 * @return the first matching calendar booking
	 * @throws com.liferay.calendar.NoSuchBookingException if a matching calendar booking could not be found
	...
	public CalendarBooking findByParentCalendarBookingId_First(
		...
		throws NoSuchBookingException, SystemException {
		return findByParentCalendarBookingId_First(parentCalendarBookingId, null);
	}
	...
	public CalendarBooking fetchByParentCalendarBookingId_First(
		long parentCalendarBookingId) throws SystemException {
		return fetchByParentCalendarBookingId_First(parentCalendarBookingId,
			null);
	}
	...
	/**
	 * Returns the last calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where parentCalendarBookingId = &#63;.
	 *
	 * @param parentCalendarBookingId the parent calendar booking ID
	 * @return the last matching calendar booking
	 * @throws com.liferay.calendar.NoSuchBookingException if a matching calendar booking could not be found
	...
	public CalendarBooking findByParentCalendarBookingId_Last(
		long parentCalendarBookingId)
		throws NoSuchBookingException, SystemException {
		return findByParentCalendarBookingId_Last(parentCalendarBookingId, null);
	}
	...
	public CalendarBooking fetchByParentCalendarBookingId_Last(
		long parentCalendarBookingId) throws SystemException {
		return fetchByParentCalendarBookingId_Last(parentCalendarBookingId, null);
	}
	...
	/**
	 * Returns the first calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where calendarResourceId = &#63; and status = &#63;.
	 *
	 * @param calendarResourceId the calendar resource ID
	 * @param status the status
	 * @return the first matching calendar booking
	...
	public CalendarBooking findByC_S_First(long calendarResourceId, int status)
		throws NoSuchBookingException, SystemException {
		return findByC_S_First(calendarResourceId, status, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CalendarBooking fetchByC_S_First(long calendarResourceId, int status)
		throws SystemException {
		return fetchByC_S_First(calendarResourceId, status, null);
	}
	...
	/**
	 * Returns the last calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where calendarResourceId = &#63; and status = &#63;.
	 *
	 * @param calendarResourceId the calendar resource ID
	 * @param status the status
	 * @return the last matching calendar booking
	...
	public CalendarBooking findByC_S_Last(long calendarResourceId, int status)
		throws NoSuchBookingException, SystemException {
		return findByC_S_Last(calendarResourceId, status, null);
	}
	...
	public CalendarBooking fetchByC_S_Last(long calendarResourceId, int status)
		throws SystemException {
		return fetchByC_S_Last(calendarResourceId, status, null);
	}
	...
	/**
	 * Returns the first calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where parentCalendarBookingId = &#63; and status = &#63;.
	 *
	 * @param parentCalendarBookingId the parent calendar booking ID
	 * @param status the status
	 * @return the first matching calendar booking
	...
	public CalendarBooking findByP_S_First(long parentCalendarBookingId,
		int status) throws NoSuchBookingException, SystemException {
		return findByP_S_First(parentCalendarBookingId, status, null);
	}
	...
	public CalendarBooking fetchByP_S_First(long parentCalendarBookingId,
		int status) throws SystemException {
		return fetchByP_S_First(parentCalendarBookingId, status, null);
	}
	...
	/**
	 * Returns the last calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where parentCalendarBookingId = &#63; and status = &#63;.
	 *
	 * @param parentCalendarBookingId the parent calendar booking ID
	 * @param status the status
	 * @return the last matching calendar booking
	...
	public CalendarBooking findByP_S_Last(long parentCalendarBookingId,
		int status) throws NoSuchBookingException, SystemException {
		return findByP_S_Last(parentCalendarBookingId, status, null);
	}
	...
	public CalendarBooking fetchByP_S_Last(long parentCalendarBookingId,
		int status) throws SystemException {
		return fetchByP_S_Last(parentCalendarBookingId, status, null);
	}
	...
	/**
	 * Returns the first calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where calendarId = &#63; and startDate = &#63; and endDate = &#63;.
	 *
	 * @param calendarId the calendar ID
	 * @param startDate the start date
	 * @param endDate the end date
	...
	public CalendarBooking findByC_S_E_First(long calendarId, long startDate,
		long endDate) throws NoSuchBookingException, SystemException {
		return findByC_S_E_First(calendarId, startDate, endDate, null);
	}
	...
	public CalendarBooking fetchByC_S_E_First(long calendarId, long startDate,
		long endDate) throws SystemException {
		return fetchByC_S_E_First(calendarId, startDate, endDate, null);
	}
	...
	/**
	 * Returns the last calendar booking in the default ordered set defined by {@link CalendarBookingModelImpl#ORDER_BY_JPQL} where calendarId = &#63; and startDate = &#63; and endDate = &#63;.
	 *
	 * @param calendarId the calendar ID
	 * @param startDate the start date
	 * @param endDate the end date
	...
	public CalendarBooking findByC_S_E_Last(long calendarId, long startDate,
		long endDate) throws NoSuchBookingException, SystemException {
		return findByC_S_E_Last(calendarId, startDate, endDate, null);
	}
	...
	public CalendarBooking fetchByC_S_E_Last(long calendarId, long startDate,
		long endDate) throws SystemException {
		return fetchByC_S_E_Last(calendarId, startDate, endDate, null);
	}
	...
	public int countByC_S_E(long calendarId, long startDate, long endDate)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_C_S_E;
