...
public class ModulePersistenceImpl extends BasePersistenceImpl<Module>
	...
	/**
	 * Returns the first module in the default ordered set defined by {@link ModuleModelImpl#ORDER_BY_JPQL} where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Module fetchByUuid_First(String uuid) throws SystemException {
	...
	/**
	 * Returns the last module in the default ordered set defined by {@link ModuleModelImpl#ORDER_BY_JPQL} where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Module fetchByUuid_Last(String uuid) throws SystemException {
	...
	/**
	 * Returns the first module in the default ordered set defined by {@link ModuleModelImpl#ORDER_BY_JPQL} where appId = &#63;.
	 *
	 * @param appId the app ID
	 * @return the first matching module
	 * @throws com.liferay.marketplace.NoSuchModuleException if a matching module could not be found
	...
	public Module findByAppId_First(long appId)
		throws NoSuchModuleException, SystemException {
		return findByAppId_First(appId, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Module fetchByAppId_First(long appId) throws SystemException {
		return fetchByAppId_First(appId, null);
	}
	...
	/**
	 * Returns the last module in the default ordered set defined by {@link ModuleModelImpl#ORDER_BY_JPQL} where appId = &#63;.
	 *
	 * @param appId the app ID
	 * @return the last matching module
	 * @throws com.liferay.marketplace.NoSuchModuleException if a matching module could not be found
	...
	public Module findByAppId_Last(long appId)
		throws NoSuchModuleException, SystemException {
		return findByAppId_Last(appId, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Module fetchByAppId_Last(long appId) throws SystemException {
		return fetchByAppId_Last(appId, null);
	}
	...
	/**
	 * Returns the first module in the default ordered set defined by {@link ModuleModelImpl#ORDER_BY_JPQL} where contextName = &#63;.
	 *
	 * @param contextName the context name
	 * @return the first matching module
	 * @throws com.liferay.marketplace.NoSuchModuleException if a matching module could not be found
	...
	public Module findByContextName_First(String contextName)
		throws NoSuchModuleException, SystemException {
		return findByContextName_First(contextName, null);
	}
	...
	public Module fetchByContextName_First(String contextName)
		throws SystemException {
		return fetchByContextName_First(contextName, null);
	}
	...
	/**
	 * Returns the last module in the default ordered set defined by {@link ModuleModelImpl#ORDER_BY_JPQL} where contextName = &#63;.
	 *
	 * @param contextName the context name
	 * @return the last matching module
	 * @throws com.liferay.marketplace.NoSuchModuleException if a matching module could not be found
	...
	public Module findByContextName_Last(String contextName)
		throws NoSuchModuleException, SystemException {
		return findByContextName_Last(contextName, null);
	}
	...
	public Module fetchByContextName_Last(String contextName)
		throws SystemException {
		return fetchByContextName_Last(contextName, null);
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_A_C = new FinderPath(ModuleModelImpl.ENTITY_CACHE_ENABLED,
			ModuleModelImpl.FINDER_CACHE_ENABLED, ModuleImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A_C = new FinderPath(ModuleModelImpl.ENTITY_CACHE_ENABLED,
			ModuleModelImpl.FINDER_CACHE_ENABLED, ModuleImpl.class,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<Module> findByA_C(long appId, String contextName, int start,
		int end, OrderByComparator orderByComparator) throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
	...
	/**
	 * Returns the first module in the default ordered set defined by {@link ModuleModelImpl#ORDER_BY_JPQL} where appId = &#63; and contextName = &#63;.
	 *
	 * @param appId the app ID
	 * @param contextName the context name
	 * @return the first matching module
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Module findByA_C_First(long appId, String contextName)
		throws NoSuchModuleException, SystemException {
		return findByA_C_First(appId, contextName, null);
	}
	...
	public Module findByA_C_First(long appId, String contextName,
		OrderByComparator orderByComparator)
		throws NoSuchModuleException, SystemException {
		Module module = fetchByA_C_First(appId, contextName, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Module fetchByA_C_First(long appId, String contextName)
		throws SystemException {
		return fetchByA_C_First(appId, contextName, null);
	}
	...
	public Module fetchByA_C_First(long appId, String contextName,
		OrderByComparator orderByComparator) throws SystemException {
		List<Module> list = findByA_C(appId, contextName, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last module in the default ordered set defined by {@link ModuleModelImpl#ORDER_BY_JPQL} where appId = &#63; and contextName = &#63;.
	 *
	 * @param appId the app ID
	 * @param contextName the context name
	 * @return the last matching module
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Module findByA_C_Last(long appId, String contextName)
		throws NoSuchModuleException, SystemException {
		return findByA_C_Last(appId, contextName, null);
	}
	...
	public Module findByA_C_Last(long appId, String contextName,
		OrderByComparator orderByComparator)
		throws NoSuchModuleException, SystemException {
		Module module = fetchByA_C_Last(appId, contextName, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Module fetchByA_C_Last(long appId, String contextName)
		throws SystemException {
		return fetchByA_C_Last(appId, contextName, null);
	}
	...
	public Module fetchByA_C_Last(long appId, String contextName,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByA_C(appId, contextName);

		List<Module> list = findByA_C(appId, contextName, count - 1, count,
				orderByComparator);
	...
	public void removeByA_C(long appId, String contextName)
		throws SystemException {
		for (Module module : findByA_C(appId, contextName, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(module);
		}
	}
