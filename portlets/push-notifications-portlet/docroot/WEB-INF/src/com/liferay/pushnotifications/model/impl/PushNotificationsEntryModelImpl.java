...
public class PushNotificationsEntryModelImpl extends BaseModelImpl<PushNotificationsEntry>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "parentEntryId", Types.BIGINT },
			{ "payload", Types.VARCHAR }
		};
	public static final String TABLE_SQL_CREATE = "create table PushNotificationsEntry (pushNotificationsEntryId LONG not null primary key,userId LONG,createDate DATE null,parentEntryId LONG,payload VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table PushNotificationsEntry";
	public static final String ORDER_BY_JPQL = " ORDER BY pushNotificationsEntry.pushNotificationsEntryId ASC";
	public static final String ORDER_BY_SQL = " ORDER BY PushNotificationsEntry.pushNotificationsEntryId ASC";
	...
	public Object clone() {
		...
		pushNotificationsEntryImpl.setCreateDate(getCreateDate());
		pushNotificationsEntryImpl.setParentEntryId(getParentEntryId());
	...
	public CacheModel<PushNotificationsEntry> toCacheModel() {
		...
		if (createDate != null) {
			pushNotificationsEntryCacheModel.createDate = createDate.getTime();
		}
		else {
			pushNotificationsEntryCacheModel.createDate = Long.MIN_VALUE;
		}

		pushNotificationsEntryCacheModel.parentEntryId = getParentEntryId();
