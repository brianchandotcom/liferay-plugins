...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry fetchByUserId_First(long userId) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry fetchByUserId_Last(long userId) throws SystemException {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_U_EA = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, EntryImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByU_EA",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_EA = new FinderPath(EntryModelImpl.ENTITY_CACHE_ENABLED,
			EntryModelImpl.FINDER_CACHE_ENABLED, EntryImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByU_EA",
	...
	/**
	 * Returns an ordered range of all the entries where userId = &#63; and emailAddress = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. When orderByComparator is specified, the query will include the given ORDER BY logic. When orderByComparator is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), the query will include the default ORDER BY logic from EntryModelImpl. If both orderByComparator and pagination are absent, for performance reason, the query will not have a ORDER BY clause, on returning the result set will be sorted in portal side by PK ASC order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<Entry> findByU_EA(long userId, String emailAddress,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_EA;
			finderArgs = new Object[] { userId, emailAddress };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_U_EA;
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry findByU_EA_First(long userId, String emailAddress)
		throws NoSuchEntryException, SystemException {
		return findByU_EA_First(userId, emailAddress, null);
	}
	...
	public Entry findByU_EA_First(long userId, String emailAddress,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		Entry entry = fetchByU_EA_First(userId, emailAddress, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry fetchByU_EA_First(long userId, String emailAddress)
		throws SystemException {
		return fetchByU_EA_First(userId, emailAddress, null);
	}
	...
	public Entry fetchByU_EA_First(long userId, String emailAddress,
		OrderByComparator orderByComparator) throws SystemException {
		List<Entry> list = findByU_EA(userId, emailAddress, 0, 1,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry findByU_EA_Last(long userId, String emailAddress)
		throws NoSuchEntryException, SystemException {
		return findByU_EA_Last(userId, emailAddress, null);
	}
	...
	public Entry findByU_EA_Last(long userId, String emailAddress,
		OrderByComparator orderByComparator)
		throws NoSuchEntryException, SystemException {
		Entry entry = fetchByU_EA_Last(userId, emailAddress, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry fetchByU_EA_Last(long userId, String emailAddress)
		throws SystemException {
		return fetchByU_EA_Last(userId, emailAddress, null);
	}
	...
	public Entry fetchByU_EA_Last(long userId, String emailAddress,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByU_EA(userId, emailAddress);

		List<Entry> list = findByU_EA(userId, emailAddress, count - 1, count,
				orderByComparator);
	...
	public void removeByU_EA(long userId, String emailAddress)
		throws SystemException {
		for (Entry entry : findByU_EA(userId, emailAddress, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(entry);
		}
	}
