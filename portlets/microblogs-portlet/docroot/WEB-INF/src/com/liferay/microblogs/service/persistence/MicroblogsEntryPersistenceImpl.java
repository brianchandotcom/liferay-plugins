...
public class MicroblogsEntryPersistenceImpl extends BasePersistenceImpl<MicroblogsEntry>
	...
	/**
	 * Returns the first microblogs entry in the default ordered set defined by {@link MicroblogsEntryModelImpl#ORDER_BY_JPQL} where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	/**
	 * Returns the last microblogs entry in the default ordered set defined by {@link MicroblogsEntryModelImpl#ORDER_BY_JPQL} where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	/**
	 * Returns the first microblogs entry in the default ordered set defined by {@link MicroblogsEntryModelImpl#ORDER_BY_JPQL} where userId = &#63;.
	 *
	 * @param userId the user ID
	 * @return the first matching microblogs entry
	 * @throws com.liferay.microblogs.NoSuchEntryException if a matching microblogs entry could not be found
	...
	/**
	 * Returns the last microblogs entry in the default ordered set defined by {@link MicroblogsEntryModelImpl#ORDER_BY_JPQL} where userId = &#63;.
	 *
	 * @param userId the user ID
	 * @return the last matching microblogs entry
	 * @throws com.liferay.microblogs.NoSuchEntryException if a matching microblogs entry could not be found
	...
	/**
	 * Returns the first microblogs entry in the default ordered set defined by {@link MicroblogsEntryModelImpl#ORDER_BY_JPQL} where userId = &#63; and type = &#63;.
	 *
	 * @param userId the user ID
	 * @param type the type
	 * @return the first matching microblogs entry
	...
	public MicroblogsEntry findByU_T_First(long userId, int type)
		throws NoSuchEntryException, SystemException {
		return findByU_T_First(userId, type, null);
	}
	...
	public MicroblogsEntry fetchByU_T_First(long userId, int type)
		throws SystemException {
		return fetchByU_T_First(userId, type, null);
	}
	...
	/**
	 * Returns the last microblogs entry in the default ordered set defined by {@link MicroblogsEntryModelImpl#ORDER_BY_JPQL} where userId = &#63; and type = &#63;.
	 *
	 * @param userId the user ID
	 * @param type the type
	 * @return the last matching microblogs entry
	...
	public MicroblogsEntry findByU_T_Last(long userId, int type)
		throws NoSuchEntryException, SystemException {
		return findByU_T_Last(userId, type, null);
	}
	...
	public MicroblogsEntry fetchByU_T_Last(long userId, int type)
		throws SystemException {
		return fetchByU_T_Last(userId, type, null);
	}
	...
	/**
	 * Returns the first microblogs entry in the default ordered set defined by {@link MicroblogsEntryModelImpl#ORDER_BY_JPQL} where type = &#63; and receiverUserId = &#63;.
	 *
	 * @param type the type
	 * @param receiverUserId the receiver user ID
	 * @return the first matching microblogs entry
	...
	public MicroblogsEntry findByT_R_First(int type, long receiverUserId)
		throws NoSuchEntryException, SystemException {
		return findByT_R_First(type, receiverUserId, null);
	}
	...
	public MicroblogsEntry fetchByT_R_First(int type, long receiverUserId)
		throws SystemException {
		return fetchByT_R_First(type, receiverUserId, null);
	}
	...
	/**
	 * Returns the last microblogs entry in the default ordered set defined by {@link MicroblogsEntryModelImpl#ORDER_BY_JPQL} where type = &#63; and receiverUserId = &#63;.
	 *
	 * @param type the type
	 * @param receiverUserId the receiver user ID
	 * @return the last matching microblogs entry
	...
	public MicroblogsEntry findByT_R_Last(int type, long receiverUserId)
		throws NoSuchEntryException, SystemException {
		return findByT_R_Last(type, receiverUserId, null);
	}
	...
	public MicroblogsEntry fetchByT_R_Last(int type, long receiverUserId)
		throws SystemException {
		return fetchByT_R_Last(type, receiverUserId, null);
	}
	...
	/**
	 * Returns the first microblogs entry in the default ordered set defined by {@link MicroblogsEntryModelImpl#ORDER_BY_JPQL} where type = &#63; and receiverMicroblogsEntryId = &#63;.
	 *
	 * @param type the type
	 * @param receiverMicroblogsEntryId the receiver microblogs entry ID
	 * @return the first matching microblogs entry
	...
	public MicroblogsEntry findByT_RMEI_First(int type,
		...
		throws NoSuchEntryException, SystemException {
		return findByT_RMEI_First(type, receiverMicroblogsEntryId, null);
	}
	...
	public MicroblogsEntry fetchByT_RMEI_First(int type,
		long receiverMicroblogsEntryId) throws SystemException {
		return fetchByT_RMEI_First(type, receiverMicroblogsEntryId, null);
	}
	...
	/**
	 * Returns the last microblogs entry in the default ordered set defined by {@link MicroblogsEntryModelImpl#ORDER_BY_JPQL} where type = &#63; and receiverMicroblogsEntryId = &#63;.
	 *
	 * @param type the type
	 * @param receiverMicroblogsEntryId the receiver microblogs entry ID
	 * @return the last matching microblogs entry
	...
	public MicroblogsEntry findByT_RMEI_Last(int type,
		long receiverMicroblogsEntryId)
		throws NoSuchEntryException, SystemException {
		return findByT_RMEI_Last(type, receiverMicroblogsEntryId, null);
	}
	...
	public MicroblogsEntry fetchByT_RMEI_Last(int type,
		long receiverMicroblogsEntryId) throws SystemException {
		return fetchByT_RMEI_Last(type, receiverMicroblogsEntryId, null);
	}
