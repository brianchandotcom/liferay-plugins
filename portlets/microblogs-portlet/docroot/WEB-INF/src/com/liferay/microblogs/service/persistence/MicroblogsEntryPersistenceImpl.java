...
public class MicroblogsEntryPersistenceImpl extends BasePersistenceImpl<MicroblogsEntry>
	...
	public List<MicroblogsEntry> filterFindByU_T(long userId, int type,
		...
		query.append(_FINDER_COLUMN_U_T_TYPE_2_);
	...
	private static final String _FINDER_COLUMN_U_T_TYPE_2_ = "microblogsEntry.type_ = ?";
	...
	public List<MicroblogsEntry> filterFindByT_R(int type, long receiverUserId,
		...
		query.append(_FINDER_COLUMN_T_R_TYPE_2_);
	...
	private static final String _FINDER_COLUMN_T_R_TYPE_2_ = "microblogsEntry.type_ = ? AND ";
	...
	public List<MicroblogsEntry> filterFindByT_RMEI(int type,
		...
		query.append(_FINDER_COLUMN_T_RMEI_TYPE_2_);
	...
	private static final String _FINDER_COLUMN_T_RMEI_TYPE_2_ = "microblogsEntry.type_ = ? AND ";
