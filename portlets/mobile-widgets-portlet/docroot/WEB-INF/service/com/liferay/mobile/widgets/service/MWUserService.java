...
/**
 * Provides the remote service interface for MWUser. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Jose M. Navarro
 * @see MWUserServiceUtil
...
public interface MWUserService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MWUserServiceUtil} to access the m w user remote service. Add custom service methods to {@link com.liferay.mobile.widgets.service.impl.MWUserServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
