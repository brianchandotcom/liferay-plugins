...
package com.liferay.mobile.widgets.service.http;
 ...
 * {@link com.liferay.mobile.widgets.service.MWUserServiceUtil} service utility. The
...
public class MWUserServiceSoap {
	...
	*/
	public static boolean sendPasswordByEmailAddress(long companyId,
		...
		try {
			boolean returnValue = MWUserServiceUtil.sendPasswordByEmailAddress(companyId,
	...
	public static boolean sendPasswordByScreenName(long companyId,
		...
		throws RemoteException {
		try {
			boolean returnValue = MWUserServiceUtil.sendPasswordByScreenName(companyId,
	...
	private static Log _log = LogFactoryUtil.getLog(MWUserServiceSoap.class);
}