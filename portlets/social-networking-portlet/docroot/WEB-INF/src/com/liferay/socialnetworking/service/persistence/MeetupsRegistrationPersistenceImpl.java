...
public class MeetupsRegistrationPersistenceImpl extends BasePersistenceImpl<MeetupsRegistration>
	...
	/**
	 * Returns the first meetups registration in the default ordered set defined by {@link MeetupsRegistrationModelImpl#ORDER_BY_JPQL} where meetupsEntryId = &#63;.
	 *
	 * @param meetupsEntryId the meetups entry ID
	...
	public MeetupsRegistration findByMeetupsEntryId_First(long meetupsEntryId)
		throws NoSuchMeetupsRegistrationException, SystemException {
		return findByMeetupsEntryId_First(meetupsEntryId, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsRegistration fetchByMeetupsEntryId_First(long meetupsEntryId)
		throws SystemException {
		return fetchByMeetupsEntryId_First(meetupsEntryId, null);
	}
	...
	/**
	 * Returns the last meetups registration in the default ordered set defined by {@link MeetupsRegistrationModelImpl#ORDER_BY_JPQL} where meetupsEntryId = &#63;.
	 *
	 * @param meetupsEntryId the meetups entry ID
	...
	public MeetupsRegistration findByMeetupsEntryId_Last(long meetupsEntryId)
		throws NoSuchMeetupsRegistrationException, SystemException {
		return findByMeetupsEntryId_Last(meetupsEntryId, null);
	}
	...
	public MeetupsRegistration fetchByMeetupsEntryId_Last(long meetupsEntryId)
		throws SystemException {
		return fetchByMeetupsEntryId_Last(meetupsEntryId, null);
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_U_ME = new FinderPath(MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED,
			MeetupsRegistrationModelImpl.FINDER_CACHE_ENABLED,
			MeetupsRegistrationImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByU_ME",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_ME = new FinderPath(MeetupsRegistrationModelImpl.ENTITY_CACHE_ENABLED,
			MeetupsRegistrationModelImpl.FINDER_CACHE_ENABLED,
			MeetupsRegistrationImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByU_ME",
	...
	/**
	 * Returns an ordered range of all the meetups registrations where userId = &#63; and meetupsEntryId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. When orderByComparator is specified, the query will include the given ORDER BY logic. When orderByComparator is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), the query will include the default ORDER BY logic from MeetupsRegistrationModelImpl. If both orderByComparator and pagination are absent, for performance reason, the query will not have a ORDER BY clause, on returning the result set will be sorted in portal side by PK ASC order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<MeetupsRegistration> findByU_ME(long userId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_ME;
			finderArgs = new Object[] { userId, meetupsEntryId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_U_ME;
			finderArgs = new Object[] {
	...
	/**
	 * Returns the first meetups registration in the default ordered set defined by {@link MeetupsRegistrationModelImpl#ORDER_BY_JPQL} where userId = &#63; and meetupsEntryId = &#63;.
	 *
	 * @param userId the user ID
	 * @param meetupsEntryId the meetups entry ID
	 * @return the first matching meetups registration
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsRegistration findByU_ME_First(long userId, long meetupsEntryId)
		throws NoSuchMeetupsRegistrationException, SystemException {
		return findByU_ME_First(userId, meetupsEntryId, null);
	}

	/**
	 * Returns the first meetups registration in the ordered set where userId = &#63; and meetupsEntryId = &#63;.
	 *
	 * @param userId the user ID
	 * @param meetupsEntryId the meetups entry ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsRegistration findByU_ME_First(long userId,
		long meetupsEntryId, OrderByComparator orderByComparator)
		throws NoSuchMeetupsRegistrationException, SystemException {
		MeetupsRegistration meetupsRegistration = fetchByU_ME_First(userId,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsRegistration fetchByU_ME_First(long userId,
		long meetupsEntryId) throws SystemException {
		return fetchByU_ME_First(userId, meetupsEntryId, null);
	}
	...
	public MeetupsRegistration fetchByU_ME_First(long userId,
		long meetupsEntryId, OrderByComparator orderByComparator)
		throws SystemException {
		List<MeetupsRegistration> list = findByU_ME(userId, meetupsEntryId, 0,
				1, orderByComparator);
	...
	/**
	 * Returns the last meetups registration in the default ordered set defined by {@link MeetupsRegistrationModelImpl#ORDER_BY_JPQL} where userId = &#63; and meetupsEntryId = &#63;.
	 *
	 * @param userId the user ID
	 * @param meetupsEntryId the meetups entry ID
	 * @return the last matching meetups registration
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsRegistration findByU_ME_Last(long userId, long meetupsEntryId)
		throws NoSuchMeetupsRegistrationException, SystemException {
		return findByU_ME_Last(userId, meetupsEntryId, null);
	}

	/**
	 * Returns the last meetups registration in the ordered set where userId = &#63; and meetupsEntryId = &#63;.
	 *
	 * @param userId the user ID
	 * @param meetupsEntryId the meetups entry ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsRegistration findByU_ME_Last(long userId,
		long meetupsEntryId, OrderByComparator orderByComparator)
		throws NoSuchMeetupsRegistrationException, SystemException {
		MeetupsRegistration meetupsRegistration = fetchByU_ME_Last(userId,
				meetupsEntryId, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsRegistration fetchByU_ME_Last(long userId, long meetupsEntryId)
		throws SystemException {
		return fetchByU_ME_Last(userId, meetupsEntryId, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsRegistration fetchByU_ME_Last(long userId,
		long meetupsEntryId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByU_ME(userId, meetupsEntryId);

		List<MeetupsRegistration> list = findByU_ME(userId, meetupsEntryId,
				count - 1, count, orderByComparator);
	...
	/**
	 * Removes all the meetups registrations where userId = &#63; and meetupsEntryId = &#63; from the database.
	 *
	 * @param userId the user ID
	 * @param meetupsEntryId the meetups entry ID
	 * @throws SystemException if a system exception occurred
	...
	public void removeByU_ME(long userId, long meetupsEntryId)
		throws SystemException {
		for (MeetupsRegistration meetupsRegistration : findByU_ME(userId,
				meetupsEntryId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(meetupsRegistration);
		}
	}
	...
	/**
	 * Returns the first meetups registration in the default ordered set defined by {@link MeetupsRegistrationModelImpl#ORDER_BY_JPQL} where meetupsEntryId = &#63; and status = &#63;.
	 *
	 * @param meetupsEntryId the meetups entry ID
	 * @param status the status
	 * @return the first matching meetups registration
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsRegistration findByME_S_First(long meetupsEntryId, int status)
		throws NoSuchMeetupsRegistrationException, SystemException {
		return findByME_S_First(meetupsEntryId, status, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsRegistration fetchByME_S_First(long meetupsEntryId, int status)
		throws SystemException {
		return fetchByME_S_First(meetupsEntryId, status, null);
	}
	...
	/**
	 * Returns the last meetups registration in the default ordered set defined by {@link MeetupsRegistrationModelImpl#ORDER_BY_JPQL} where meetupsEntryId = &#63; and status = &#63;.
	 *
	 * @param meetupsEntryId the meetups entry ID
	 * @param status the status
	 * @return the last matching meetups registration
	...
	public MeetupsRegistration findByME_S_Last(long meetupsEntryId, int status)
		throws NoSuchMeetupsRegistrationException, SystemException {
		return findByME_S_Last(meetupsEntryId, status, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MeetupsRegistration fetchByME_S_Last(long meetupsEntryId, int status)
		throws SystemException {
		return fetchByME_S_Last(meetupsEntryId, status, null);
	}
