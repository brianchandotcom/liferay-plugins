...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	/**
	 * Returns the first foo in the default ordered set defined by {@link FooModelImpl#ORDER_BY_JPQL} where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Foo fetchByUuid_First(String uuid) throws SystemException {
	...
	/**
	 * Returns the last foo in the default ordered set defined by {@link FooModelImpl#ORDER_BY_JPQL} where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Foo fetchByUuid_Last(String uuid) throws SystemException {
	...
	/**
	 * Returns the first foo in the default ordered set defined by {@link FooModelImpl#ORDER_BY_JPQL} where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @return the first matching foo
	...
	/**
	 * Returns the last foo in the default ordered set defined by {@link FooModelImpl#ORDER_BY_JPQL} where uuid = &#63; and companyId = &#63;.
	 *
	 * @param uuid the uuid
	 * @param companyId the company ID
	 * @return the last matching foo
	...
	/**
	 * Returns the first foo in the default ordered set defined by {@link FooModelImpl#ORDER_BY_JPQL} where field2 = &#63;.
	 *
	 * @param field2 the field2
	 * @return the first matching foo
	 * @throws com.liferay.sampleservicebuilder.NoSuchFooException if a matching foo could not be found
	...
	public Foo findByField2_First(boolean field2)
		throws NoSuchFooException, SystemException {
		return findByField2_First(field2, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Foo fetchByField2_First(boolean field2) throws SystemException {
		return fetchByField2_First(field2, null);
	}
	...
	/**
	 * Returns the last foo in the default ordered set defined by {@link FooModelImpl#ORDER_BY_JPQL} where field2 = &#63;.
	 *
	 * @param field2 the field2
	 * @return the last matching foo
	 * @throws com.liferay.sampleservicebuilder.NoSuchFooException if a matching foo could not be found
	...
	public Foo findByField2_Last(boolean field2)
		throws NoSuchFooException, SystemException {
		return findByField2_Last(field2, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Foo fetchByField2_Last(boolean field2) throws SystemException {
		return fetchByField2_Last(field2, null);
	}
