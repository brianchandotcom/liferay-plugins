...
public class AccountPersistenceImpl extends BasePersistenceImpl<Account>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account fetchByUserId_First(long userId) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account fetchByUserId_Last(long userId) throws SystemException {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_U_A = new FinderPath(AccountModelImpl.ENTITY_CACHE_ENABLED,
			AccountModelImpl.FINDER_CACHE_ENABLED, AccountImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_A = new FinderPath(AccountModelImpl.ENTITY_CACHE_ENABLED,
			AccountModelImpl.FINDER_CACHE_ENABLED, AccountImpl.class,
	...
	/**
	 * Returns an ordered range of all the accounts where userId = &#63; and address = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. When orderByComparator is specified, the query will include the given ORDER BY logic. When orderByComparator is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), the query will include the default ORDER BY logic from AccountModelImpl. If both orderByComparator and pagination are absent, for performance reason, the query will not have a ORDER BY clause, on returning the result set will be sorted in portal side by PK ASC order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<Account> findByU_A(long userId, String address, int start,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account findByU_A_First(long userId, String address)
		throws NoSuchAccountException, SystemException {
		return findByU_A_First(userId, address, null);
	}
	...
	public Account findByU_A_First(long userId, String address,
		OrderByComparator orderByComparator)
		throws NoSuchAccountException, SystemException {
		Account account = fetchByU_A_First(userId, address, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account fetchByU_A_First(long userId, String address)
		throws SystemException {
		return fetchByU_A_First(userId, address, null);
	}
	...
	public Account fetchByU_A_First(long userId, String address,
		OrderByComparator orderByComparator) throws SystemException {
		List<Account> list = findByU_A(userId, address, 0, 1, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account findByU_A_Last(long userId, String address)
		throws NoSuchAccountException, SystemException {
		return findByU_A_Last(userId, address, null);
	}
	...
	public Account findByU_A_Last(long userId, String address,
		OrderByComparator orderByComparator)
		throws NoSuchAccountException, SystemException {
		Account account = fetchByU_A_Last(userId, address, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Account fetchByU_A_Last(long userId, String address)
		throws SystemException {
		return fetchByU_A_Last(userId, address, null);
	}
	...
	public Account fetchByU_A_Last(long userId, String address,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByU_A(userId, address);

		List<Account> list = findByU_A(userId, address, count - 1, count,
				orderByComparator);
	...
	public void removeByU_A(long userId, String address)
		throws SystemException {
		for (Account account : findByU_A(userId, address, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(account);
		}
	}
