...
public class MessagePersistenceImpl extends BasePersistenceImpl<Message>
	...
	/**
	 * Returns the first message in the default ordered set defined by {@link MessageModelImpl#ORDER_BY_JPQL} where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	/**
	 * Returns the last message in the default ordered set defined by {@link MessageModelImpl#ORDER_BY_JPQL} where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	/**
	 * Returns the first message in the default ordered set defined by {@link MessageModelImpl#ORDER_BY_JPQL} where folderId = &#63;.
	 *
	 * @param folderId the folder ID
	 * @return the first matching message
	 * @throws com.liferay.mail.NoSuchMessageException if a matching message could not be found
	...
	public Message findByFolderId_First(long folderId)
		throws NoSuchMessageException, SystemException {
		return findByFolderId_First(folderId, null);
	}
	...
	public Message fetchByFolderId_First(long folderId)
		throws SystemException {
		return fetchByFolderId_First(folderId, null);
	}
	...
	/**
	 * Returns the last message in the default ordered set defined by {@link MessageModelImpl#ORDER_BY_JPQL} where folderId = &#63;.
	 *
	 * @param folderId the folder ID
	 * @return the last matching message
	 * @throws com.liferay.mail.NoSuchMessageException if a matching message could not be found
	...
	public Message findByFolderId_Last(long folderId)
		throws NoSuchMessageException, SystemException {
		return findByFolderId_Last(folderId, null);
	}
	...
	public Message fetchByFolderId_Last(long folderId)
		throws SystemException {
		return fetchByFolderId_Last(folderId, null);
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_F_R = new FinderPath(MessageModelImpl.ENTITY_CACHE_ENABLED,
			MessageModelImpl.FINDER_CACHE_ENABLED, MessageImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByF_R",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_R = new FinderPath(MessageModelImpl.ENTITY_CACHE_ENABLED,
			MessageModelImpl.FINDER_CACHE_ENABLED, MessageImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByF_R",
	...
	/**
	 * Returns an ordered range of all the messages where folderId = &#63; and remoteMessageId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. When orderByComparator is specified, the query will include the given ORDER BY logic. When orderByComparator is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), the query will include the default ORDER BY logic from MessageModelImpl. If both orderByComparator and pagination are absent, for performance reason, the query will not have a ORDER BY clause, on returning the result set will be sorted in portal side by PK ASC order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<Message> findByF_R(long folderId, long remoteMessageId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_F_R;
			finderArgs = new Object[] { folderId, remoteMessageId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_F_R;
	...
	/**
	 * Returns the first message in the default ordered set defined by {@link MessageModelImpl#ORDER_BY_JPQL} where folderId = &#63; and remoteMessageId = &#63;.
	 *
	 * @param folderId the folder ID
	 * @param remoteMessageId the remote message ID
	 * @return the first matching message
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Message findByF_R_First(long folderId, long remoteMessageId)
		throws NoSuchMessageException, SystemException {
		return findByF_R_First(folderId, remoteMessageId, null);
	}

	/**
	 * Returns the first message in the ordered set where folderId = &#63; and remoteMessageId = &#63;.
	 *
	 * @param folderId the folder ID
	 * @param remoteMessageId the remote message ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Message findByF_R_First(long folderId, long remoteMessageId,
		OrderByComparator orderByComparator)
		throws NoSuchMessageException, SystemException {
		Message message = fetchByF_R_First(folderId, remoteMessageId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Message fetchByF_R_First(long folderId, long remoteMessageId)
		throws SystemException {
		return fetchByF_R_First(folderId, remoteMessageId, null);
	}
	...
	public Message fetchByF_R_First(long folderId, long remoteMessageId,
		OrderByComparator orderByComparator) throws SystemException {
		List<Message> list = findByF_R(folderId, remoteMessageId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last message in the default ordered set defined by {@link MessageModelImpl#ORDER_BY_JPQL} where folderId = &#63; and remoteMessageId = &#63;.
	 *
	 * @param folderId the folder ID
	 * @param remoteMessageId the remote message ID
	 * @return the last matching message
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Message findByF_R_Last(long folderId, long remoteMessageId)
		throws NoSuchMessageException, SystemException {
		return findByF_R_Last(folderId, remoteMessageId, null);
	}

	/**
	 * Returns the last message in the ordered set where folderId = &#63; and remoteMessageId = &#63;.
	 *
	 * @param folderId the folder ID
	 * @param remoteMessageId the remote message ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Message findByF_R_Last(long folderId, long remoteMessageId,
		OrderByComparator orderByComparator)
		throws NoSuchMessageException, SystemException {
		Message message = fetchByF_R_Last(folderId, remoteMessageId,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Message fetchByF_R_Last(long folderId, long remoteMessageId)
		throws SystemException {
		return fetchByF_R_Last(folderId, remoteMessageId, null);
	}
	...
	public Message fetchByF_R_Last(long folderId, long remoteMessageId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByF_R(folderId, remoteMessageId);

		List<Message> list = findByF_R(folderId, remoteMessageId, count - 1,
	...
	/**
	 * Removes all the messages where folderId = &#63; and remoteMessageId = &#63; from the database.
	 *
	 * @param folderId the folder ID
	 * @param remoteMessageId the remote message ID
	 * @throws SystemException if a system exception occurred
	...
	public void removeByF_R(long folderId, long remoteMessageId)
		throws SystemException {
		for (Message message : findByF_R(folderId, remoteMessageId,
