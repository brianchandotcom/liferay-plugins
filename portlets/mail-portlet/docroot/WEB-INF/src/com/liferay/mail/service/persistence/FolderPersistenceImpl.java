...
public class FolderPersistenceImpl extends BasePersistenceImpl<Folder>
	...
	/**
	 * Returns the first folder in the default ordered set defined by {@link FolderModelImpl#ORDER_BY_JPQL} where accountId = &#63;.
	 *
	 * @param accountId the account ID
	...
	public Folder findByAccountId_First(long accountId)
		throws NoSuchFolderException, SystemException {
		return findByAccountId_First(accountId, null);
	}
	...
	public Folder fetchByAccountId_First(long accountId)
		throws SystemException {
		return fetchByAccountId_First(accountId, null);
	}
	...
	/**
	 * Returns the last folder in the default ordered set defined by {@link FolderModelImpl#ORDER_BY_JPQL} where accountId = &#63;.
	 *
	 * @param accountId the account ID
	...
	public Folder findByAccountId_Last(long accountId)
		throws NoSuchFolderException, SystemException {
		return findByAccountId_Last(accountId, null);
	}
	...
	public Folder fetchByAccountId_Last(long accountId)
		throws SystemException {
		return fetchByAccountId_Last(accountId, null);
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_A_F = new FinderPath(FolderModelImpl.ENTITY_CACHE_ENABLED,
			FolderModelImpl.FINDER_CACHE_ENABLED, FolderImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByA_F",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A_F = new FinderPath(FolderModelImpl.ENTITY_CACHE_ENABLED,
			FolderModelImpl.FINDER_CACHE_ENABLED, FolderImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByA_F",
	...
	/**
	 * Returns an ordered range of all the folders where accountId = &#63; and fullName = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. When orderByComparator is specified, the query will include the given ORDER BY logic. When orderByComparator is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), the query will include the default ORDER BY logic from FolderModelImpl. If both orderByComparator and pagination are absent, for performance reason, the query will not have a ORDER BY clause, on returning the result set will be sorted in portal side by PK ASC order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<Folder> findByA_F(long accountId, String fullName,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A_F;
			finderArgs = new Object[] { accountId, fullName };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_A_F;
	...
	/**
	 * Returns the first folder in the default ordered set defined by {@link FolderModelImpl#ORDER_BY_JPQL} where accountId = &#63; and fullName = &#63;.
	 *
	 * @param accountId the account ID
	 * @param fullName the full name
	 * @return the first matching folder
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Folder findByA_F_First(long accountId, String fullName)
		throws NoSuchFolderException, SystemException {
		return findByA_F_First(accountId, fullName, null);
	}

	/**
	 * Returns the first folder in the ordered set where accountId = &#63; and fullName = &#63;.
	 *
	 * @param accountId the account ID
	 * @param fullName the full name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Folder findByA_F_First(long accountId, String fullName,
		OrderByComparator orderByComparator)
		throws NoSuchFolderException, SystemException {
		Folder folder = fetchByA_F_First(accountId, fullName, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Folder fetchByA_F_First(long accountId, String fullName)
		throws SystemException {
		return fetchByA_F_First(accountId, fullName, null);
	}
	...
	public Folder fetchByA_F_First(long accountId, String fullName,
		OrderByComparator orderByComparator) throws SystemException {
		List<Folder> list = findByA_F(accountId, fullName, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last folder in the default ordered set defined by {@link FolderModelImpl#ORDER_BY_JPQL} where accountId = &#63; and fullName = &#63;.
	 *
	 * @param accountId the account ID
	 * @param fullName the full name
	 * @return the last matching folder
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Folder findByA_F_Last(long accountId, String fullName)
		throws NoSuchFolderException, SystemException {
		return findByA_F_Last(accountId, fullName, null);
	}

	/**
	 * Returns the last folder in the ordered set where accountId = &#63; and fullName = &#63;.
	 *
	 * @param accountId the account ID
	 * @param fullName the full name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Folder findByA_F_Last(long accountId, String fullName,
		OrderByComparator orderByComparator)
		throws NoSuchFolderException, SystemException {
		Folder folder = fetchByA_F_Last(accountId, fullName, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Folder fetchByA_F_Last(long accountId, String fullName)
		throws SystemException {
		return fetchByA_F_Last(accountId, fullName, null);
	}
	...
	public Folder fetchByA_F_Last(long accountId, String fullName,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByA_F(accountId, fullName);

		List<Folder> list = findByA_F(accountId, fullName, count - 1, count,
				orderByComparator);
	...
	/**
	 * Removes all the folders where accountId = &#63; and fullName = &#63; from the database.
	 *
	 * @param accountId the account ID
	 * @param fullName the full name
	 * @throws SystemException if a system exception occurred
	...
	public void removeByA_F(long accountId, String fullName)
		throws SystemException {
		for (Folder folder : findByA_F(accountId, fullName, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(folder);
		}
	}
