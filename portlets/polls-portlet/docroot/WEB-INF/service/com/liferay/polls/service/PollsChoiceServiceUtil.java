...
/**
 * The utility for the polls choice remote service. This utility wraps {@link com.liferay.polls.service.impl.PollsChoiceServiceImpl} and is the primary access point for service operations in application layer code running on a remote server.
 *
 * <p>
	...
	public static PollsChoiceService getService() {
		if (_service == null) {
			InvokableService invokableService = (InvokableService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					PollsChoiceService.class.getName());

			if (invokableService instanceof PollsChoiceService) {
				_service = (PollsChoiceService)invokableService;
			}
			else {
				_service = new PollsChoiceServiceClp(invokableService);
			}
