...
public abstract class HRExpenseCurrencyLocalServiceBaseImpl
	...
	public HRExpenseCurrency addHRExpenseCurrency(
		...
		hrExpenseCurrency = hrExpenseCurrencyPersistence.update(hrExpenseCurrency,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(hrExpenseCurrency);
			}
	...
	public void deleteHRExpenseCurrency(long hrExpenseCurrencyId)
		...
		HRExpenseCurrency hrExpenseCurrency = hrExpenseCurrencyPersistence.remove(hrExpenseCurrencyId);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(hrExpenseCurrency);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return hrExpenseCurrencyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public HRExpenseCurrency updateHRExpenseCurrency(
		HRExpenseCurrency hrExpenseCurrency) throws SystemException {
		return updateHRExpenseCurrency(hrExpenseCurrency, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.liferay.hr.model.HRExpenseCurrency",
			hrExpenseCurrencyLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.liferay.hr.model.HRExpenseCurrency");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(HRExpenseCurrencyLocalServiceBaseImpl.class);
