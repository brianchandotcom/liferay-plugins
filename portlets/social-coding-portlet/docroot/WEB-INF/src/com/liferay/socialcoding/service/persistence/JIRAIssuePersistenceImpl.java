...
public class JIRAIssuePersistenceImpl extends BasePersistenceImpl<JIRAIssue>
	...
	/**
	 * Returns the first j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where projectId = &#63;.
	 *
	 * @param projectId the project ID
	...
	public JIRAIssue findByProjectId_First(long projectId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByProjectId_First(projectId, null);
	}
	...
	public JIRAIssue fetchByProjectId_First(long projectId)
		throws SystemException {
		return fetchByProjectId_First(projectId, null);
	}
	...
	/**
	 * Returns the last j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where projectId = &#63;.
	 *
	 * @param projectId the project ID
	...
	public JIRAIssue findByProjectId_Last(long projectId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByProjectId_Last(projectId, null);
	}
	...
	public JIRAIssue fetchByProjectId_Last(long projectId)
		throws SystemException {
		return fetchByProjectId_Last(projectId, null);
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_KEY = new FinderPath(JIRAIssueModelImpl.ENTITY_CACHE_ENABLED,
			JIRAIssueModelImpl.FINDER_CACHE_ENABLED, JIRAIssueImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_KEY = new FinderPath(JIRAIssueModelImpl.ENTITY_CACHE_ENABLED,
			JIRAIssueModelImpl.FINDER_CACHE_ENABLED, JIRAIssueImpl.class,
	...
	/**
	 * Returns an ordered range of all the j i r a issues where key = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. When orderByComparator is specified, the query will include the given ORDER BY logic. When orderByComparator is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), the query will include the default ORDER BY logic from JIRAIssueModelImpl. If both orderByComparator and pagination are absent, for performance reason, the query will not have a ORDER BY clause, on returning the result set will be sorted in portal side by PK ASC order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<JIRAIssue> findByKey(String key, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
	...
	/**
	 * Returns the first j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where key = &#63;.
	 *
	 * @param key the key
	 * @return the first matching j i r a issue
	 * @throws com.liferay.socialcoding.NoSuchJIRAIssueException if a matching j i r a issue could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public JIRAIssue findByKey_First(String key)
		throws NoSuchJIRAIssueException, SystemException {
		return findByKey_First(key, null);
	}

	/**
	 * Returns the first j i r a issue in the ordered set where key = &#63;.
	 *
	 * @param key the key
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching j i r a issue
	...
	public JIRAIssue findByKey_First(String key,
		OrderByComparator orderByComparator)
		throws NoSuchJIRAIssueException, SystemException {
		JIRAIssue jiraIssue = fetchByKey_First(key, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JIRAIssue fetchByKey_First(String key) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JIRAIssue fetchByKey_First(String key,
		OrderByComparator orderByComparator) throws SystemException {
		List<JIRAIssue> list = findByKey(key, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where key = &#63;.
	 *
	 * @param key the key
	 * @return the last matching j i r a issue
	 * @throws com.liferay.socialcoding.NoSuchJIRAIssueException if a matching j i r a issue could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public JIRAIssue findByKey_Last(String key)
		throws NoSuchJIRAIssueException, SystemException {
		return findByKey_Last(key, null);
	}

	/**
	 * Returns the last j i r a issue in the ordered set where key = &#63;.
	 *
	 * @param key the key
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching j i r a issue
	...
	public JIRAIssue findByKey_Last(String key,
		OrderByComparator orderByComparator)
		throws NoSuchJIRAIssueException, SystemException {
		JIRAIssue jiraIssue = fetchByKey_Last(key, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JIRAIssue fetchByKey_Last(String key) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JIRAIssue fetchByKey_Last(String key,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByKey(key);

		List<JIRAIssue> list = findByKey(key, count - 1, count,
				orderByComparator);
	...
	/**
	 * Removes all the j i r a issues where key = &#63; from the database.
	 *
	 * @param key the key
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByKey(String key) throws SystemException {
		for (JIRAIssue jiraIssue : findByKey(key, QueryUtil.ALL_POS,
	...
	/**
	 * Returns the first j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where reporterJiraUserId = &#63;.
	 *
	 * @param reporterJiraUserId the reporter jira user ID
	 * @return the first matching j i r a issue
	 * @throws com.liferay.socialcoding.NoSuchJIRAIssueException if a matching j i r a issue could not be found
	...
	public JIRAIssue findByReporterJiraUserId_First(String reporterJiraUserId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByReporterJiraUserId_First(reporterJiraUserId, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JIRAIssue fetchByReporterJiraUserId_First(String reporterJiraUserId)
		throws SystemException {
		return fetchByReporterJiraUserId_First(reporterJiraUserId, null);
	}
	...
	/**
	 * Returns the last j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where reporterJiraUserId = &#63;.
	 *
	 * @param reporterJiraUserId the reporter jira user ID
	 * @return the last matching j i r a issue
	 * @throws com.liferay.socialcoding.NoSuchJIRAIssueException if a matching j i r a issue could not be found
	...
	public JIRAIssue findByReporterJiraUserId_Last(String reporterJiraUserId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByReporterJiraUserId_Last(reporterJiraUserId, null);
	}
	...
	public JIRAIssue fetchByReporterJiraUserId_Last(String reporterJiraUserId)
		throws SystemException {
		return fetchByReporterJiraUserId_Last(reporterJiraUserId, null);
	}
	...
	/**
	 * Returns the first j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where assigneeJiraUserId = &#63;.
	 *
	 * @param assigneeJiraUserId the assignee jira user ID
	 * @return the first matching j i r a issue
	 * @throws com.liferay.socialcoding.NoSuchJIRAIssueException if a matching j i r a issue could not be found
	...
	public JIRAIssue findByAssigneeJiraUserId_First(String assigneeJiraUserId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByAssigneeJiraUserId_First(assigneeJiraUserId, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JIRAIssue fetchByAssigneeJiraUserId_First(String assigneeJiraUserId)
		throws SystemException {
		return fetchByAssigneeJiraUserId_First(assigneeJiraUserId, null);
	}
	...
	/**
	 * Returns the last j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where assigneeJiraUserId = &#63;.
	 *
	 * @param assigneeJiraUserId the assignee jira user ID
	 * @return the last matching j i r a issue
	 * @throws com.liferay.socialcoding.NoSuchJIRAIssueException if a matching j i r a issue could not be found
	...
	public JIRAIssue findByAssigneeJiraUserId_Last(String assigneeJiraUserId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByAssigneeJiraUserId_Last(assigneeJiraUserId, null);
	}
	...
	public JIRAIssue fetchByAssigneeJiraUserId_Last(String assigneeJiraUserId)
		throws SystemException {
		return fetchByAssigneeJiraUserId_Last(assigneeJiraUserId, null);
	}
	...
	/**
	 * Returns the first j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where modifiedDate &gt; &#63; and projectId = &#63;.
	 *
	 * @param modifiedDate the modified date
	 * @param projectId the project ID
	 * @return the first matching j i r a issue
	...
	public JIRAIssue findByMD_P_First(Date modifiedDate, long projectId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByMD_P_First(modifiedDate, projectId, null);
	}
	...
	public JIRAIssue fetchByMD_P_First(Date modifiedDate, long projectId)
		throws SystemException {
		return fetchByMD_P_First(modifiedDate, projectId, null);
	}
	...
	/**
	 * Returns the last j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where modifiedDate &gt; &#63; and projectId = &#63;.
	 *
	 * @param modifiedDate the modified date
	 * @param projectId the project ID
	 * @return the last matching j i r a issue
	...
	public JIRAIssue findByMD_P_Last(Date modifiedDate, long projectId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByMD_P_Last(modifiedDate, projectId, null);
	}
	...
	public JIRAIssue fetchByMD_P_Last(Date modifiedDate, long projectId)
		throws SystemException {
		return fetchByMD_P_Last(modifiedDate, projectId, null);
	}
	...
	/**
	 * Returns the first j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where projectId = &#63; and reporterJiraUserId = &#63;.
	 *
	 * @param projectId the project ID
	 * @param reporterJiraUserId the reporter jira user ID
	 * @return the first matching j i r a issue
	...
	public JIRAIssue findByP_RJUI_First(long projectId,
		...
		throws NoSuchJIRAIssueException, SystemException {
		return findByP_RJUI_First(projectId, reporterJiraUserId, null);
	}
	...
	public JIRAIssue fetchByP_RJUI_First(long projectId,
		String reporterJiraUserId) throws SystemException {
		return fetchByP_RJUI_First(projectId, reporterJiraUserId, null);
	}
	...
	/**
	 * Returns the last j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where projectId = &#63; and reporterJiraUserId = &#63;.
	 *
	 * @param projectId the project ID
	 * @param reporterJiraUserId the reporter jira user ID
	 * @return the last matching j i r a issue
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JIRAIssue findByP_RJUI_Last(long projectId, String reporterJiraUserId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByP_RJUI_Last(projectId, reporterJiraUserId, null);
	}
	...
	public JIRAIssue fetchByP_RJUI_Last(long projectId,
		String reporterJiraUserId) throws SystemException {
		return fetchByP_RJUI_Last(projectId, reporterJiraUserId, null);
	}
	...
	/**
	 * Returns the first j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where projectId = &#63; and assigneeJiraUserId = &#63;.
	 *
	 * @param projectId the project ID
	 * @param assigneeJiraUserId the assignee jira user ID
	 * @return the first matching j i r a issue
	...
	public JIRAIssue findByP_AJUI_First(long projectId,
		...
		throws NoSuchJIRAIssueException, SystemException {
		return findByP_AJUI_First(projectId, assigneeJiraUserId, null);
	}
	...
	public JIRAIssue fetchByP_AJUI_First(long projectId,
		String assigneeJiraUserId) throws SystemException {
		return fetchByP_AJUI_First(projectId, assigneeJiraUserId, null);
	}
	...
	/**
	 * Returns the last j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where projectId = &#63; and assigneeJiraUserId = &#63;.
	 *
	 * @param projectId the project ID
	 * @param assigneeJiraUserId the assignee jira user ID
	 * @return the last matching j i r a issue
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public JIRAIssue findByP_AJUI_Last(long projectId, String assigneeJiraUserId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByP_AJUI_Last(projectId, assigneeJiraUserId, null);
	}
	...
	public JIRAIssue fetchByP_AJUI_Last(long projectId,
		String assigneeJiraUserId) throws SystemException {
		return fetchByP_AJUI_Last(projectId, assigneeJiraUserId, null);
	}
	...
	/**
	 * Returns the first j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where modifiedDate &gt; &#63; and projectId = &#63; and reporterJiraUserId = &#63;.
	 *
	 * @param modifiedDate the modified date
	 * @param projectId the project ID
	 * @param reporterJiraUserId the reporter jira user ID
	...
	public JIRAIssue findByMD_P_RJUI_First(Date modifiedDate, long projectId,
		String reporterJiraUserId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByMD_P_RJUI_First(modifiedDate, projectId,
			reporterJiraUserId, null);
	}
	...
	public JIRAIssue fetchByMD_P_RJUI_First(Date modifiedDate, long projectId,
		String reporterJiraUserId) throws SystemException {
		return fetchByMD_P_RJUI_First(modifiedDate, projectId,
			reporterJiraUserId, null);
	}
	...
	/**
	 * Returns the last j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where modifiedDate &gt; &#63; and projectId = &#63; and reporterJiraUserId = &#63;.
	 *
	 * @param modifiedDate the modified date
	 * @param projectId the project ID
	 * @param reporterJiraUserId the reporter jira user ID
	...
	public JIRAIssue findByMD_P_RJUI_Last(Date modifiedDate, long projectId,
		String reporterJiraUserId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByMD_P_RJUI_Last(modifiedDate, projectId,
			reporterJiraUserId, null);
	}
	...
	public JIRAIssue fetchByMD_P_RJUI_Last(Date modifiedDate, long projectId,
		String reporterJiraUserId) throws SystemException {
		return fetchByMD_P_RJUI_Last(modifiedDate, projectId,
			reporterJiraUserId, null);
	}
	...
	/**
	 * Returns the first j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where modifiedDate &gt; &#63; and projectId = &#63; and assigneeJiraUserId = &#63;.
	 *
	 * @param modifiedDate the modified date
	 * @param projectId the project ID
	 * @param assigneeJiraUserId the assignee jira user ID
	...
	public JIRAIssue findByMD_P_AJUI_First(Date modifiedDate, long projectId,
		String assigneeJiraUserId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByMD_P_AJUI_First(modifiedDate, projectId,
			assigneeJiraUserId, null);
	}
	...
	public JIRAIssue fetchByMD_P_AJUI_First(Date modifiedDate, long projectId,
		String assigneeJiraUserId) throws SystemException {
		return fetchByMD_P_AJUI_First(modifiedDate, projectId,
			assigneeJiraUserId, null);
	}
	...
	/**
	 * Returns the last j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where modifiedDate &gt; &#63; and projectId = &#63; and assigneeJiraUserId = &#63;.
	 *
	 * @param modifiedDate the modified date
	 * @param projectId the project ID
	 * @param assigneeJiraUserId the assignee jira user ID
	...
	public JIRAIssue findByMD_P_AJUI_Last(Date modifiedDate, long projectId,
		String assigneeJiraUserId)
		throws NoSuchJIRAIssueException, SystemException {
		return findByMD_P_AJUI_Last(modifiedDate, projectId,
			assigneeJiraUserId, null);
	}
	...
	public JIRAIssue fetchByMD_P_AJUI_Last(Date modifiedDate, long projectId,
		String assigneeJiraUserId) throws SystemException {
		return fetchByMD_P_AJUI_Last(modifiedDate, projectId,
			assigneeJiraUserId, null);
	}
	...
	/**
	 * Returns the first j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where projectId = &#63; and reporterJiraUserId = &#63; and status = &#63;.
	 *
	 * @param projectId the project ID
	 * @param reporterJiraUserId the reporter jira user ID
	 * @param status the status
	...
	public JIRAIssue findByP_RJUI_S_First(long projectId,
		...
		throws NoSuchJIRAIssueException, SystemException {
		return findByP_RJUI_S_First(projectId, reporterJiraUserId, status, null);
	}
	...
	public JIRAIssue fetchByP_RJUI_S_First(long projectId,
		String reporterJiraUserId, String status) throws SystemException {
		return fetchByP_RJUI_S_First(projectId, reporterJiraUserId, status, null);
	}
	...
	/**
	 * Returns the last j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where projectId = &#63; and reporterJiraUserId = &#63; and status = &#63;.
	 *
	 * @param projectId the project ID
	 * @param reporterJiraUserId the reporter jira user ID
	 * @param status the status
	...
	public JIRAIssue findByP_RJUI_S_Last(long projectId,
		String reporterJiraUserId, String status)
		throws NoSuchJIRAIssueException, SystemException {
		return findByP_RJUI_S_Last(projectId, reporterJiraUserId, status, null);
	}
	...
	public JIRAIssue fetchByP_RJUI_S_Last(long projectId,
		String reporterJiraUserId, String status) throws SystemException {
		return fetchByP_RJUI_S_Last(projectId, reporterJiraUserId, status, null);
	}
	...
	/**
	 * Returns the first j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where projectId = &#63; and assigneeJiraUserId = &#63; and status = &#63;.
	 *
	 * @param projectId the project ID
	 * @param assigneeJiraUserId the assignee jira user ID
	 * @param status the status
	...
	public JIRAIssue findByP_AJUI_S_First(long projectId,
		...
		throws NoSuchJIRAIssueException, SystemException {
		return findByP_AJUI_S_First(projectId, assigneeJiraUserId, status, null);
	}
	...
	public JIRAIssue fetchByP_AJUI_S_First(long projectId,
		String assigneeJiraUserId, String status) throws SystemException {
		return fetchByP_AJUI_S_First(projectId, assigneeJiraUserId, status, null);
	}
	...
	/**
	 * Returns the last j i r a issue in the default ordered set defined by {@link JIRAIssueModelImpl#ORDER_BY_JPQL} where projectId = &#63; and assigneeJiraUserId = &#63; and status = &#63;.
	 *
	 * @param projectId the project ID
	 * @param assigneeJiraUserId the assignee jira user ID
	 * @param status the status
	...
	public JIRAIssue findByP_AJUI_S_Last(long projectId,
		String assigneeJiraUserId, String status)
		throws NoSuchJIRAIssueException, SystemException {
		return findByP_AJUI_S_Last(projectId, assigneeJiraUserId, status, null);
	}
	...
	public JIRAIssue fetchByP_AJUI_S_Last(long projectId,
		String assigneeJiraUserId, String status) throws SystemException {
		return fetchByP_AJUI_S_Last(projectId, assigneeJiraUserId, status, null);
	}
