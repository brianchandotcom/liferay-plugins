...
public class OAuthConsumerPersistenceImpl extends BasePersistenceImpl<OAuthConsumer>
	...
	/**
	 * Returns the first o auth consumer in the default ordered set defined by {@link OAuthConsumerModelImpl#ORDER_BY_JPQL} where gadgetKey = &#63;.
	 *
	 * @param gadgetKey the gadget key
	...
	public OAuthConsumer findByGadgetKey_First(String gadgetKey)
		throws NoSuchOAuthConsumerException, SystemException {
		return findByGadgetKey_First(gadgetKey, null);
	}
	...
	public OAuthConsumer fetchByGadgetKey_First(String gadgetKey)
		throws SystemException {
		return fetchByGadgetKey_First(gadgetKey, null);
	}
	...
	/**
	 * Returns the last o auth consumer in the default ordered set defined by {@link OAuthConsumerModelImpl#ORDER_BY_JPQL} where gadgetKey = &#63;.
	 *
	 * @param gadgetKey the gadget key
	...
	public OAuthConsumer findByGadgetKey_Last(String gadgetKey)
		throws NoSuchOAuthConsumerException, SystemException {
		return findByGadgetKey_Last(gadgetKey, null);
	}
	...
	public OAuthConsumer fetchByGadgetKey_Last(String gadgetKey)
		throws SystemException {
		return fetchByGadgetKey_Last(gadgetKey, null);
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_S = new FinderPath(OAuthConsumerModelImpl.ENTITY_CACHE_ENABLED,
			OAuthConsumerModelImpl.FINDER_CACHE_ENABLED,
			OAuthConsumerImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_S",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_S = new FinderPath(OAuthConsumerModelImpl.ENTITY_CACHE_ENABLED,
			OAuthConsumerModelImpl.FINDER_CACHE_ENABLED,
			OAuthConsumerImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_S",
	...
	/**
	 * Returns an ordered range of all the o auth consumers where gadgetKey = &#63; and serviceName = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. When orderByComparator is specified, the query will include the given ORDER BY logic. When orderByComparator is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), the query will include the default ORDER BY logic from OAuthConsumerModelImpl. If both orderByComparator and pagination are absent, for performance reason, the query will not have a ORDER BY clause, on returning the result set will be sorted in portal side by PK ASC order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<OAuthConsumer> findByG_S(String gadgetKey,
	...
	/**
	 * Returns the first o auth consumer in the default ordered set defined by {@link OAuthConsumerModelImpl#ORDER_BY_JPQL} where gadgetKey = &#63; and serviceName = &#63;.
	 *
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	 * @return the first matching o auth consumer
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthConsumer findByG_S_First(String gadgetKey, String serviceName)
		throws NoSuchOAuthConsumerException, SystemException {
		return findByG_S_First(gadgetKey, serviceName, null);
	}

	/**
	 * Returns the first o auth consumer in the ordered set where gadgetKey = &#63; and serviceName = &#63;.
	 *
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public OAuthConsumer findByG_S_First(String gadgetKey, String serviceName,
		OrderByComparator orderByComparator)
		throws NoSuchOAuthConsumerException, SystemException {
		OAuthConsumer oAuthConsumer = fetchByG_S_First(gadgetKey, serviceName,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthConsumer fetchByG_S_First(String gadgetKey, String serviceName)
		throws SystemException {
	...
	public OAuthConsumer fetchByG_S_First(String gadgetKey, String serviceName,
		OrderByComparator orderByComparator) throws SystemException {
		List<OAuthConsumer> list = findByG_S(gadgetKey, serviceName, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last o auth consumer in the default ordered set defined by {@link OAuthConsumerModelImpl#ORDER_BY_JPQL} where gadgetKey = &#63; and serviceName = &#63;.
	 *
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	 * @return the last matching o auth consumer
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthConsumer findByG_S_Last(String gadgetKey, String serviceName)
		throws NoSuchOAuthConsumerException, SystemException {
		return findByG_S_Last(gadgetKey, serviceName, null);
	}

	/**
	 * Returns the last o auth consumer in the ordered set where gadgetKey = &#63; and serviceName = &#63;.
	 *
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public OAuthConsumer findByG_S_Last(String gadgetKey, String serviceName,
		OrderByComparator orderByComparator)
		throws NoSuchOAuthConsumerException, SystemException {
		OAuthConsumer oAuthConsumer = fetchByG_S_Last(gadgetKey, serviceName,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthConsumer fetchByG_S_Last(String gadgetKey, String serviceName)
		throws SystemException {
	...
	public OAuthConsumer fetchByG_S_Last(String gadgetKey, String serviceName,
		...
		List<OAuthConsumer> list = findByG_S(gadgetKey, serviceName, count - 1,
	...
	/**
	 * Removes all the o auth consumers where gadgetKey = &#63; and serviceName = &#63; from the database.
	 *
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	 * @throws SystemException if a system exception occurred
	...
	public void removeByG_S(String gadgetKey, String serviceName)
		throws SystemException {
		for (OAuthConsumer oAuthConsumer : findByG_S(gadgetKey, serviceName,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(oAuthConsumer);
		}
	}
