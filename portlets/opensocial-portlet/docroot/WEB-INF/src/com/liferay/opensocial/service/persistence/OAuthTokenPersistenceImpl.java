...
public class OAuthTokenPersistenceImpl extends BasePersistenceImpl<OAuthToken>
	...
	/**
	 * Returns the first o auth token in the default ordered set defined by {@link OAuthTokenModelImpl#ORDER_BY_JPQL} where gadgetKey = &#63; and serviceName = &#63;.
	 *
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	...
	public OAuthToken findByG_S_First(String gadgetKey, String serviceName)
		throws NoSuchOAuthTokenException, SystemException {
		return findByG_S_First(gadgetKey, serviceName, null);
	}
	...
	public OAuthToken fetchByG_S_First(String gadgetKey, String serviceName)
		throws SystemException {
		return fetchByG_S_First(gadgetKey, serviceName, null);
	}
	...
	/**
	 * Returns the last o auth token in the default ordered set defined by {@link OAuthTokenModelImpl#ORDER_BY_JPQL} where gadgetKey = &#63; and serviceName = &#63;.
	 *
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	...
	public OAuthToken findByG_S_Last(String gadgetKey, String serviceName)
		throws NoSuchOAuthTokenException, SystemException {
		return findByG_S_Last(gadgetKey, serviceName, null);
	}
	...
	public OAuthToken fetchByG_S_Last(String gadgetKey, String serviceName)
		throws SystemException {
		return fetchByG_S_Last(gadgetKey, serviceName, null);
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_U_G_S_M_T =
		new FinderPath(OAuthTokenModelImpl.ENTITY_CACHE_ENABLED,
			OAuthTokenModelImpl.FINDER_CACHE_ENABLED, OAuthTokenImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByU_G_S_M_T",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_G_S_M_T =
		new FinderPath(OAuthTokenModelImpl.ENTITY_CACHE_ENABLED,
			OAuthTokenModelImpl.FINDER_CACHE_ENABLED, OAuthTokenImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByU_G_S_M_T",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName(), Long.class.getName(),
				String.class.getName()
	...
	/**
	 * Returns an ordered range of all the o auth tokens where userId = &#63; and gadgetKey = &#63; and serviceName = &#63; and moduleId = &#63; and tokenName = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. When orderByComparator is specified, the query will include the given ORDER BY logic. When orderByComparator is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), the query will include the default ORDER BY logic from OAuthTokenModelImpl. If both orderByComparator and pagination are absent, for performance reason, the query will not have a ORDER BY clause, on returning the result set will be sorted in portal side by PK ASC order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<OAuthToken> findByU_G_S_M_T(long userId, String gadgetKey,
		String serviceName, long moduleId, String tokenName, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_G_S_M_T;
			finderArgs = new Object[] {
					userId, gadgetKey, serviceName, moduleId, tokenName
				};
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_U_G_S_M_T;
			finderArgs = new Object[] {
					userId, gadgetKey, serviceName, moduleId, tokenName,
	...
	/**
	 * Returns the first o auth token in the default ordered set defined by {@link OAuthTokenModelImpl#ORDER_BY_JPQL} where userId = &#63; and gadgetKey = &#63; and serviceName = &#63; and moduleId = &#63; and tokenName = &#63;.
	 *
	 * @param userId the user ID
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthToken findByU_G_S_M_T_First(long userId, String gadgetKey,
		String serviceName, long moduleId, String tokenName)
		throws NoSuchOAuthTokenException, SystemException {
		return findByU_G_S_M_T_First(userId, gadgetKey, serviceName, moduleId,
			tokenName, null);
	}

	/**
	 * Returns the first o auth token in the ordered set where userId = &#63; and gadgetKey = &#63; and serviceName = &#63; and moduleId = &#63; and tokenName = &#63;.
	 *
	 * @param userId the user ID
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	...
	public OAuthToken findByU_G_S_M_T_First(long userId, String gadgetKey,
		...
		OrderByComparator orderByComparator)
		throws NoSuchOAuthTokenException, SystemException {
		OAuthToken oAuthToken = fetchByU_G_S_M_T_First(userId, gadgetKey,
				serviceName, moduleId, tokenName, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthToken fetchByU_G_S_M_T_First(long userId, String gadgetKey,
		String serviceName, long moduleId, String tokenName)
		throws SystemException {
		return fetchByU_G_S_M_T_First(userId, gadgetKey, serviceName, moduleId,
			tokenName, null);
	}
	...
	public OAuthToken fetchByU_G_S_M_T_First(long userId, String gadgetKey,
		String serviceName, long moduleId, String tokenName,
		OrderByComparator orderByComparator) throws SystemException {
		List<OAuthToken> list = findByU_G_S_M_T(userId, gadgetKey, serviceName,
				moduleId, tokenName, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last o auth token in the default ordered set defined by {@link OAuthTokenModelImpl#ORDER_BY_JPQL} where userId = &#63; and gadgetKey = &#63; and serviceName = &#63; and moduleId = &#63; and tokenName = &#63;.
	 *
	 * @param userId the user ID
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthToken findByU_G_S_M_T_Last(long userId, String gadgetKey,
		String serviceName, long moduleId, String tokenName)
		throws NoSuchOAuthTokenException, SystemException {
		return findByU_G_S_M_T_Last(userId, gadgetKey, serviceName, moduleId,
			tokenName, null);
	}

	/**
	 * Returns the last o auth token in the ordered set where userId = &#63; and gadgetKey = &#63; and serviceName = &#63; and moduleId = &#63; and tokenName = &#63;.
	 *
	 * @param userId the user ID
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	...
	public OAuthToken findByU_G_S_M_T_Last(long userId, String gadgetKey,
		...
		OrderByComparator orderByComparator)
		throws NoSuchOAuthTokenException, SystemException {
		OAuthToken oAuthToken = fetchByU_G_S_M_T_Last(userId, gadgetKey,
				serviceName, moduleId, tokenName, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public OAuthToken fetchByU_G_S_M_T_Last(long userId, String gadgetKey,
		String serviceName, long moduleId, String tokenName)
		throws SystemException {
		return fetchByU_G_S_M_T_Last(userId, gadgetKey, serviceName, moduleId,
			tokenName, null);
	}
	...
	public OAuthToken fetchByU_G_S_M_T_Last(long userId, String gadgetKey,
		String serviceName, long moduleId, String tokenName,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByU_G_S_M_T(userId, gadgetKey, serviceName, moduleId,
				tokenName);

		List<OAuthToken> list = findByU_G_S_M_T(userId, gadgetKey, serviceName,
				moduleId, tokenName, count - 1, count, orderByComparator);
	...
	/**
	 * Removes all the o auth tokens where userId = &#63; and gadgetKey = &#63; and serviceName = &#63; and moduleId = &#63; and tokenName = &#63; from the database.
	 *
	 * @param userId the user ID
	 * @param gadgetKey the gadget key
	 * @param serviceName the service name
	...
	public void removeByU_G_S_M_T(long userId, String gadgetKey,
		String serviceName, long moduleId, String tokenName)
		throws SystemException {
		for (OAuthToken oAuthToken : findByU_G_S_M_T(userId, gadgetKey,
				serviceName, moduleId, tokenName, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(oAuthToken);
		}
	}
