...
public class MemberRequestPersistenceImpl extends BasePersistenceImpl<MemberRequest>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_KEY = new FinderPath(MemberRequestModelImpl.ENTITY_CACHE_ENABLED,
			MemberRequestModelImpl.FINDER_CACHE_ENABLED,
			MemberRequestImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByKey",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_KEY = new FinderPath(MemberRequestModelImpl.ENTITY_CACHE_ENABLED,
			MemberRequestModelImpl.FINDER_CACHE_ENABLED,
			MemberRequestImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	 ...
	 */
	protected List<MemberRequest> findByKey(String key, int start, int end,
	...
	/**
	 * Returns the first member request in the default ordered set defined by {@link MemberRequestModelImpl#ORDER_BY_JPQL} where key = &#63;.
	 *
	 * @param key the key
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MemberRequest findByKey_First(String key)
		throws NoSuchMemberRequestException, SystemException {
		return findByKey_First(key, null);
	}

	/**
	 * Returns the first member request in the ordered set where key = &#63;.
	 *
	 * @param key the key
	...
	public MemberRequest findByKey_First(String key,
		...
		throws NoSuchMemberRequestException, SystemException {
		MemberRequest memberRequest = fetchByKey_First(key, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MemberRequest fetchByKey_First(String key) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MemberRequest fetchByKey_First(String key,
		OrderByComparator orderByComparator) throws SystemException {
		List<MemberRequest> list = findByKey(key, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last member request in the default ordered set defined by {@link MemberRequestModelImpl#ORDER_BY_JPQL} where key = &#63;.
	 *
	 * @param key the key
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MemberRequest findByKey_Last(String key)
		throws NoSuchMemberRequestException, SystemException {
		return findByKey_Last(key, null);
	}

	/**
	 * Returns the last member request in the ordered set where key = &#63;.
	 *
	 * @param key the key
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching member request
	...
	public MemberRequest findByKey_Last(String key,
		OrderByComparator orderByComparator)
		throws NoSuchMemberRequestException, SystemException {
		MemberRequest memberRequest = fetchByKey_Last(key, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MemberRequest fetchByKey_Last(String key) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MemberRequest fetchByKey_Last(String key,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByKey(key);

		List<MemberRequest> list = findByKey(key, count - 1, count,
				orderByComparator);
	...
	/**
	 * Removes all the member requests where key = &#63; from the database.
	 *
	 * @param key the key
	 * @throws SystemException if a system exception occurred
	 */
	public void removeByKey(String key) throws SystemException {
		for (MemberRequest memberRequest : findByKey(key, QueryUtil.ALL_POS,
	...
	/**
	 * Returns the first member request in the default ordered set defined by {@link MemberRequestModelImpl#ORDER_BY_JPQL} where receiverUserId = &#63;.
	 *
	 * @param receiverUserId the receiver user ID
	 * @return the first matching member request
	 * @throws com.liferay.so.NoSuchMemberRequestException if a matching member request could not be found
	...
	/**
	 * Returns the last member request in the default ordered set defined by {@link MemberRequestModelImpl#ORDER_BY_JPQL} where receiverUserId = &#63;.
	 *
	 * @param receiverUserId the receiver user ID
	 * @return the last matching member request
	 * @throws com.liferay.so.NoSuchMemberRequestException if a matching member request could not be found
	...
	/**
	 * Returns the first member request in the default ordered set defined by {@link MemberRequestModelImpl#ORDER_BY_JPQL} where receiverUserId = &#63; and status = &#63;.
	 *
	 * @param receiverUserId the receiver user ID
	 * @param status the status
	 * @return the first matching member request
	...
	/**
	 * Returns the last member request in the default ordered set defined by {@link MemberRequestModelImpl#ORDER_BY_JPQL} where receiverUserId = &#63; and status = &#63;.
	 *
	 * @param receiverUserId the receiver user ID
	 * @param status the status
	 * @return the last matching member request
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_R_S = new FinderPath(MemberRequestModelImpl.ENTITY_CACHE_ENABLED,
			MemberRequestModelImpl.FINDER_CACHE_ENABLED,
			MemberRequestImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_R_S",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_R_S = new FinderPath(MemberRequestModelImpl.ENTITY_CACHE_ENABLED,
			MemberRequestModelImpl.FINDER_CACHE_ENABLED,
			MemberRequestImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findByG_R_S",
			new String[] {
	...
	/**
	 * Returns an ordered range of all the member requests where groupId = &#63; and receiverUserId = &#63; and status = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. When orderByComparator is specified, the query will include the given ORDER BY logic. When orderByComparator is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), the query will include the default ORDER BY logic from MemberRequestModelImpl. If both orderByComparator and pagination are absent, for performance reason, the query will not have a ORDER BY clause, on returning the result set will be sorted in portal side by PK ASC order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<MemberRequest> findByG_R_S(long groupId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_R_S;
			finderArgs = new Object[] { groupId, receiverUserId, status };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_R_S;
			finderArgs = new Object[] {
	...
	/**
	 * Returns the first member request in the default ordered set defined by {@link MemberRequestModelImpl#ORDER_BY_JPQL} where groupId = &#63; and receiverUserId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param receiverUserId the receiver user ID
	 * @param status the status
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MemberRequest findByG_R_S_First(long groupId, long receiverUserId,
		int status) throws NoSuchMemberRequestException, SystemException {
		return findByG_R_S_First(groupId, receiverUserId, status, null);
	}

	/**
	 * Returns the first member request in the ordered set where groupId = &#63; and receiverUserId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param receiverUserId the receiver user ID
	 * @param status the status
	...
	public MemberRequest findByG_R_S_First(long groupId, long receiverUserId,
		...
		throws NoSuchMemberRequestException, SystemException {
		MemberRequest memberRequest = fetchByG_R_S_First(groupId,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MemberRequest fetchByG_R_S_First(long groupId, long receiverUserId,
		int status) throws SystemException {
		return fetchByG_R_S_First(groupId, receiverUserId, status, null);
	}
	...
	public MemberRequest fetchByG_R_S_First(long groupId, long receiverUserId,
		int status, OrderByComparator orderByComparator)
		throws SystemException {
		List<MemberRequest> list = findByG_R_S(groupId, receiverUserId, status,
	...
	/**
	 * Returns the last member request in the default ordered set defined by {@link MemberRequestModelImpl#ORDER_BY_JPQL} where groupId = &#63; and receiverUserId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param receiverUserId the receiver user ID
	 * @param status the status
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MemberRequest findByG_R_S_Last(long groupId, long receiverUserId,
		int status) throws NoSuchMemberRequestException, SystemException {
		return findByG_R_S_Last(groupId, receiverUserId, status, null);
	}

	/**
	 * Returns the last member request in the ordered set where groupId = &#63; and receiverUserId = &#63; and status = &#63;.
	 *
	 * @param groupId the group ID
	 * @param receiverUserId the receiver user ID
	 * @param status the status
	...
	public MemberRequest findByG_R_S_Last(long groupId, long receiverUserId,
		int status, OrderByComparator orderByComparator)
		throws NoSuchMemberRequestException, SystemException {
		MemberRequest memberRequest = fetchByG_R_S_Last(groupId,
				receiverUserId, status, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public MemberRequest fetchByG_R_S_Last(long groupId, long receiverUserId,
		int status) throws SystemException {
		return fetchByG_R_S_Last(groupId, receiverUserId, status, null);
	}
	...
	public MemberRequest fetchByG_R_S_Last(long groupId, long receiverUserId,
		int status, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByG_R_S(groupId, receiverUserId, status);
	...
	/**
	 * Removes all the member requests where groupId = &#63; and receiverUserId = &#63; and status = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param receiverUserId the receiver user ID
	 * @param status the status
	...
	public void removeByG_R_S(long groupId, long receiverUserId, int status)
		throws SystemException {
		for (MemberRequest memberRequest : findByG_R_S(groupId, receiverUserId,
