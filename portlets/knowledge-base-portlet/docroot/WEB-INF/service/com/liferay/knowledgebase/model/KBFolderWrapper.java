...
public class KBFolderWrapper implements KBFolder, ModelWrapper<KBFolder> {
	...
	*/
	...
	/**
	* Returns the parent kb folder ID of this k b folder.
	*
	* @return the parent kb folder ID of this k b folder
	*/
	@Override
	...
	*/
	...
	/**
	* Sets the parent kb folder ID of this k b folder.
	*
	* @param parentKbFolderId the parent kb folder ID of this k b folder
	*/
	@Override
