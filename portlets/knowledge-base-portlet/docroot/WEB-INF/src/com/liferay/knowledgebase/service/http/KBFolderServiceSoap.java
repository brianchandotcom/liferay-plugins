...
public class KBFolderServiceSoap {
	...
	public static com.liferay.knowledgebase.model.KBFolderSoap getFolder(
		long kbFolderId) throws RemoteException {
		try {
			com.liferay.knowledgebase.model.KBFolder returnValue = KBFolderServiceUtil.getFolder(kbFolderId);
