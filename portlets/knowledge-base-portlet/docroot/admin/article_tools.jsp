...
<div class="kb-article-tools">
	...
	<tr>
		<c:if test="<%= KnowledgeBaseUtil.RSS_FEED_ENABLED && (kbArticle.isApproved() || !kbArticle.isFirstVersion()) && !Validator.equals(portletDisplay.getRootPortletId(), PortletKeys.KNOWLEDGE_BASE_ADMIN) %>">
			<td>
