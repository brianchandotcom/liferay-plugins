...
public class StatusPersistenceImpl extends BasePersistenceImpl<Status>
	...
	/**
	 * Returns the first status in the default ordered set defined by {@link StatusModelImpl#ORDER_BY_JPQL} where modifiedDate = &#63;.
	 *
	 * @param modifiedDate the modified date
	...
	public Status findByModifiedDate_First(long modifiedDate)
		throws NoSuchStatusException, SystemException {
		return findByModifiedDate_First(modifiedDate, null);
	}
	...
	public Status fetchByModifiedDate_First(long modifiedDate)
		throws SystemException {
		return fetchByModifiedDate_First(modifiedDate, null);
	}
	...
	/**
	 * Returns the last status in the default ordered set defined by {@link StatusModelImpl#ORDER_BY_JPQL} where modifiedDate = &#63;.
	 *
	 * @param modifiedDate the modified date
	...
	public Status findByModifiedDate_Last(long modifiedDate)
		throws NoSuchStatusException, SystemException {
		return findByModifiedDate_Last(modifiedDate, null);
	}
	...
	public Status fetchByModifiedDate_Last(long modifiedDate)
		throws SystemException {
		return fetchByModifiedDate_Last(modifiedDate, null);
	}
	...
	/**
	 * Returns the first status in the default ordered set defined by {@link StatusModelImpl#ORDER_BY_JPQL} where online = &#63;.
	 *
	 * @param online the online
	 * @return the first matching status
	 * @throws com.liferay.chat.NoSuchStatusException if a matching status could not be found
	...
	public Status findByOnline_First(boolean online)
		throws NoSuchStatusException, SystemException {
		return findByOnline_First(online, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Status fetchByOnline_First(boolean online) throws SystemException {
		return fetchByOnline_First(online, null);
	}
	...
	/**
	 * Returns the last status in the default ordered set defined by {@link StatusModelImpl#ORDER_BY_JPQL} where online = &#63;.
	 *
	 * @param online the online
	 * @return the last matching status
	 * @throws com.liferay.chat.NoSuchStatusException if a matching status could not be found
	...
	public Status findByOnline_Last(boolean online)
		throws NoSuchStatusException, SystemException {
		return findByOnline_Last(online, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Status fetchByOnline_Last(boolean online) throws SystemException {
		return fetchByOnline_Last(online, null);
	}
	...
	/**
	 * Returns the first status in the default ordered set defined by {@link StatusModelImpl#ORDER_BY_JPQL} where modifiedDate = &#63; and online = &#63;.
	 *
	 * @param modifiedDate the modified date
	 * @param online the online
	 * @return the first matching status
	...
	public Status findByM_O_First(long modifiedDate, boolean online)
		throws NoSuchStatusException, SystemException {
		return findByM_O_First(modifiedDate, online, null);
	}
	...
	public Status fetchByM_O_First(long modifiedDate, boolean online)
		throws SystemException {
		return fetchByM_O_First(modifiedDate, online, null);
	}
	...
	/**
	 * Returns the last status in the default ordered set defined by {@link StatusModelImpl#ORDER_BY_JPQL} where modifiedDate = &#63; and online = &#63;.
	 *
	 * @param modifiedDate the modified date
	 * @param online the online
	 * @return the last matching status
	...
	public Status findByM_O_Last(long modifiedDate, boolean online)
		throws NoSuchStatusException, SystemException {
		return findByM_O_Last(modifiedDate, online, null);
	}
	...
	public Status fetchByM_O_Last(long modifiedDate, boolean online)
		throws SystemException {
		return fetchByM_O_Last(modifiedDate, online, null);
	}
