...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	...
	/**
	 * Returns the first entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where createDate = &#63;.
	 *
	 * @param createDate the create date
	...
	public Entry findByCreateDate_First(long createDate)
		throws NoSuchEntryException, SystemException {
		return findByCreateDate_First(createDate, null);
	}
	...
	public Entry fetchByCreateDate_First(long createDate)
		throws SystemException {
		return fetchByCreateDate_First(createDate, null);
	}
	...
	/**
	 * Returns the last entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where createDate = &#63;.
	 *
	 * @param createDate the create date
	...
	public Entry findByCreateDate_Last(long createDate)
		throws NoSuchEntryException, SystemException {
		return findByCreateDate_Last(createDate, null);
	}
	...
	public Entry fetchByCreateDate_Last(long createDate)
		throws SystemException {
		return fetchByCreateDate_Last(createDate, null);
	}
	...
	/**
	 * Returns the first entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where fromUserId = &#63;.
	 *
	 * @param fromUserId the from user ID
	 * @return the first matching entry
	 * @throws com.liferay.chat.NoSuchEntryException if a matching entry could not be found
	...
	public Entry findByFromUserId_First(long fromUserId)
		throws NoSuchEntryException, SystemException {
		return findByFromUserId_First(fromUserId, null);
	}
	...
	public Entry fetchByFromUserId_First(long fromUserId)
		throws SystemException {
		return fetchByFromUserId_First(fromUserId, null);
	}
	...
	/**
	 * Returns the last entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where fromUserId = &#63;.
	 *
	 * @param fromUserId the from user ID
	 * @return the last matching entry
	 * @throws com.liferay.chat.NoSuchEntryException if a matching entry could not be found
	...
	public Entry findByFromUserId_Last(long fromUserId)
		throws NoSuchEntryException, SystemException {
		return findByFromUserId_Last(fromUserId, null);
	}
	...
	public Entry fetchByFromUserId_Last(long fromUserId)
		throws SystemException {
		return fetchByFromUserId_Last(fromUserId, null);
	}
	...
	/**
	 * Returns the first entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where toUserId = &#63;.
	 *
	 * @param toUserId the to user ID
	 * @return the first matching entry
	 * @throws com.liferay.chat.NoSuchEntryException if a matching entry could not be found
	...
	public Entry findByToUserId_First(long toUserId)
		throws NoSuchEntryException, SystemException {
		return findByToUserId_First(toUserId, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry fetchByToUserId_First(long toUserId) throws SystemException {
		return fetchByToUserId_First(toUserId, null);
	}
	...
	/**
	 * Returns the last entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where toUserId = &#63;.
	 *
	 * @param toUserId the to user ID
	 * @return the last matching entry
	 * @throws com.liferay.chat.NoSuchEntryException if a matching entry could not be found
	...
	public Entry findByToUserId_Last(long toUserId)
		throws NoSuchEntryException, SystemException {
		return findByToUserId_Last(toUserId, null);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry fetchByToUserId_Last(long toUserId) throws SystemException {
		return fetchByToUserId_Last(toUserId, null);
	}
	...
	/**
	 * Returns the first entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where createDate = &#63; and fromUserId = &#63;.
	 *
	 * @param createDate the create date
	 * @param fromUserId the from user ID
	 * @return the first matching entry
	...
	public Entry findByC_F_First(long createDate, long fromUserId)
		throws NoSuchEntryException, SystemException {
		return findByC_F_First(createDate, fromUserId, null);
	}
	...
	public Entry fetchByC_F_First(long createDate, long fromUserId)
		throws SystemException {
		return fetchByC_F_First(createDate, fromUserId, null);
	}
	...
	/**
	 * Returns the last entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where createDate = &#63; and fromUserId = &#63;.
	 *
	 * @param createDate the create date
	 * @param fromUserId the from user ID
	 * @return the last matching entry
	...
	public Entry findByC_F_Last(long createDate, long fromUserId)
		throws NoSuchEntryException, SystemException {
		return findByC_F_Last(createDate, fromUserId, null);
	}
	...
	public Entry fetchByC_F_Last(long createDate, long fromUserId)
		throws SystemException {
		return fetchByC_F_Last(createDate, fromUserId, null);
	}
	...
	/**
	 * Returns the first entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where createDate = &#63; and toUserId = &#63;.
	 *
	 * @param createDate the create date
	 * @param toUserId the to user ID
	 * @return the first matching entry
	...
	public Entry findByC_T_First(long createDate, long toUserId)
		throws NoSuchEntryException, SystemException {
		return findByC_T_First(createDate, toUserId, null);
	}
	...
	public Entry fetchByC_T_First(long createDate, long toUserId)
		throws SystemException {
		return fetchByC_T_First(createDate, toUserId, null);
	}
	...
	/**
	 * Returns the last entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where createDate = &#63; and toUserId = &#63;.
	 *
	 * @param createDate the create date
	 * @param toUserId the to user ID
	 * @return the last matching entry
	...
	public Entry findByC_T_Last(long createDate, long toUserId)
		throws NoSuchEntryException, SystemException {
		return findByC_T_Last(createDate, toUserId, null);
	}
	...
	public Entry fetchByC_T_Last(long createDate, long toUserId)
		throws SystemException {
		return fetchByC_T_Last(createDate, toUserId, null);
	}
	...
	/**
	 * Returns the first entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where createDate = &#63; and fromUserId = &#63; and toUserId = &#63;.
	 *
	 * @param createDate the create date
	 * @param fromUserId the from user ID
	 * @param toUserId the to user ID
	...
	public Entry findByC_F_T_First(long createDate, long fromUserId,
		long toUserId) throws NoSuchEntryException, SystemException {
		return findByC_F_T_First(createDate, fromUserId, toUserId, null);
	}
	...
	public Entry fetchByC_F_T_First(long createDate, long fromUserId,
		long toUserId) throws SystemException {
		return fetchByC_F_T_First(createDate, fromUserId, toUserId, null);
	}
	...
	/**
	 * Returns the last entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where createDate = &#63; and fromUserId = &#63; and toUserId = &#63;.
	 *
	 * @param createDate the create date
	 * @param fromUserId the from user ID
	 * @param toUserId the to user ID
	...
	public Entry findByC_F_T_Last(long createDate, long fromUserId,
		long toUserId) throws NoSuchEntryException, SystemException {
		return findByC_F_T_Last(createDate, fromUserId, toUserId, null);
	}
	...
	public Entry fetchByC_F_T_Last(long createDate, long fromUserId,
		long toUserId) throws SystemException {
		return fetchByC_F_T_Last(createDate, fromUserId, toUserId, null);
	}
	...
	/**
	 * Returns the first entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where fromUserId = &#63; and toUserId = &#63; and content = &#63;.
	 *
	 * @param fromUserId the from user ID
	 * @param toUserId the to user ID
	 * @param content the content
	...
	public Entry findByF_T_C_First(long fromUserId, long toUserId,
		String content) throws NoSuchEntryException, SystemException {
		return findByF_T_C_First(fromUserId, toUserId, content, null);
	}
	...
	public Entry fetchByF_T_C_First(long fromUserId, long toUserId,
		String content) throws SystemException {
		return fetchByF_T_C_First(fromUserId, toUserId, content, null);
	}
	...
	/**
	 * Returns the last entry in the default ordered set defined by {@link EntryModelImpl#ORDER_BY_JPQL} where fromUserId = &#63; and toUserId = &#63; and content = &#63;.
	 *
	 * @param fromUserId the from user ID
	 * @param toUserId the to user ID
	 * @param content the content
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entry findByF_T_C_Last(long fromUserId, long toUserId, String content)
		throws NoSuchEntryException, SystemException {
		return findByF_T_C_Last(fromUserId, toUserId, content, null);
	}
	...
	public Entry fetchByF_T_C_Last(long fromUserId, long toUserId,
		String content) throws SystemException {
		return fetchByF_T_C_Last(fromUserId, toUserId, content, null);
	}
