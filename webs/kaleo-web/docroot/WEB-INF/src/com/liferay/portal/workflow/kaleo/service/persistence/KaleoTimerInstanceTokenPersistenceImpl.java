...
public class KaleoTimerInstanceTokenPersistenceImpl extends BasePersistenceImpl<KaleoTimerInstanceToken>
	...
	/**
	 * Returns the first kaleo timer instance token in the default ordered set defined by {@link KaleoTimerInstanceTokenModelImpl#ORDER_BY_JPQL} where kaleoInstanceId = &#63;.
	 *
	 * @param kaleoInstanceId the kaleo instance ID
	...
	public KaleoTimerInstanceToken findByKaleoInstanceId_First(
		...
		throws NoSuchTimerInstanceTokenException, SystemException {
		return findByKaleoInstanceId_First(kaleoInstanceId, null);
	}
	...
	public KaleoTimerInstanceToken fetchByKaleoInstanceId_First(
		long kaleoInstanceId) throws SystemException {
		return fetchByKaleoInstanceId_First(kaleoInstanceId, null);
	}
	...
	/**
	 * Returns the last kaleo timer instance token in the default ordered set defined by {@link KaleoTimerInstanceTokenModelImpl#ORDER_BY_JPQL} where kaleoInstanceId = &#63;.
	 *
	 * @param kaleoInstanceId the kaleo instance ID
	...
	public KaleoTimerInstanceToken findByKaleoInstanceId_Last(
		long kaleoInstanceId)
		throws NoSuchTimerInstanceTokenException, SystemException {
		return findByKaleoInstanceId_Last(kaleoInstanceId, null);
	}
	...
	public KaleoTimerInstanceToken fetchByKaleoInstanceId_Last(
		long kaleoInstanceId) throws SystemException {
		return fetchByKaleoInstanceId_Last(kaleoInstanceId, null);
	}
	...
	private static final String _FINDER_COLUMN_KALEOINSTANCEID_KALEOINSTANCEID_2 =
		"kaleoTimerInstanceToken.kaleoInstanceId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_KITI_KTI = new FinderPath(KaleoTimerInstanceTokenModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTimerInstanceTokenModelImpl.FINDER_CACHE_ENABLED,
			KaleoTimerInstanceTokenImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByKITI_KTI",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_KITI_KTI =
		new FinderPath(KaleoTimerInstanceTokenModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTimerInstanceTokenModelImpl.FINDER_CACHE_ENABLED,
			KaleoTimerInstanceTokenImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByKITI_KTI",
	...
	/**
	 * Returns an ordered range of all the kaleo timer instance tokens where kaleoInstanceTokenId = &#63; and kaleoTimerId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. When orderByComparator is specified, the query will include the given ORDER BY logic. When orderByComparator is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), the query will include the default ORDER BY logic from KaleoTimerInstanceTokenModelImpl. If both orderByComparator and pagination are absent, for performance reason, the query will not have a ORDER BY clause, on returning the result set will be sorted in portal side by PK ASC order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<KaleoTimerInstanceToken> findByKITI_KTI(
		long kaleoInstanceTokenId, long kaleoTimerId, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_KITI_KTI;
			finderArgs = new Object[] { kaleoInstanceTokenId, kaleoTimerId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_KITI_KTI;
			finderArgs = new Object[] {
	...
	/**
	 * Returns the first kaleo timer instance token in the default ordered set defined by {@link KaleoTimerInstanceTokenModelImpl#ORDER_BY_JPQL} where kaleoInstanceTokenId = &#63; and kaleoTimerId = &#63;.
	 *
	 * @param kaleoInstanceTokenId the kaleo instance token ID
	 * @param kaleoTimerId the kaleo timer ID
	 * @return the first matching kaleo timer instance token
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KaleoTimerInstanceToken findByKITI_KTI_First(
		long kaleoInstanceTokenId, long kaleoTimerId)
		throws NoSuchTimerInstanceTokenException, SystemException {
		return findByKITI_KTI_First(kaleoInstanceTokenId, kaleoTimerId, null);
	}

	/**
	 * Returns the first kaleo timer instance token in the ordered set where kaleoInstanceTokenId = &#63; and kaleoTimerId = &#63;.
	 *
	 * @param kaleoInstanceTokenId the kaleo instance token ID
	 * @param kaleoTimerId the kaleo timer ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public KaleoTimerInstanceToken findByKITI_KTI_First(
		...
		OrderByComparator orderByComparator)
		throws NoSuchTimerInstanceTokenException, SystemException {
		KaleoTimerInstanceToken kaleoTimerInstanceToken = fetchByKITI_KTI_First(kaleoInstanceTokenId,
				kaleoTimerId, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KaleoTimerInstanceToken fetchByKITI_KTI_First(
		long kaleoInstanceTokenId, long kaleoTimerId) throws SystemException {
		return fetchByKITI_KTI_First(kaleoInstanceTokenId, kaleoTimerId, null);
	}
	...
	public KaleoTimerInstanceToken fetchByKITI_KTI_First(
		long kaleoInstanceTokenId, long kaleoTimerId,
		OrderByComparator orderByComparator) throws SystemException {
		List<KaleoTimerInstanceToken> list = findByKITI_KTI(kaleoInstanceTokenId,
				kaleoTimerId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last kaleo timer instance token in the default ordered set defined by {@link KaleoTimerInstanceTokenModelImpl#ORDER_BY_JPQL} where kaleoInstanceTokenId = &#63; and kaleoTimerId = &#63;.
	 *
	 * @param kaleoInstanceTokenId the kaleo instance token ID
	 * @param kaleoTimerId the kaleo timer ID
	 * @return the last matching kaleo timer instance token
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KaleoTimerInstanceToken findByKITI_KTI_Last(
		long kaleoInstanceTokenId, long kaleoTimerId)
		throws NoSuchTimerInstanceTokenException, SystemException {
		return findByKITI_KTI_Last(kaleoInstanceTokenId, kaleoTimerId, null);
	}

	/**
	 * Returns the last kaleo timer instance token in the ordered set where kaleoInstanceTokenId = &#63; and kaleoTimerId = &#63;.
	 *
	 * @param kaleoInstanceTokenId the kaleo instance token ID
	 * @param kaleoTimerId the kaleo timer ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public KaleoTimerInstanceToken findByKITI_KTI_Last(
		...
		OrderByComparator orderByComparator)
		throws NoSuchTimerInstanceTokenException, SystemException {
		KaleoTimerInstanceToken kaleoTimerInstanceToken = fetchByKITI_KTI_Last(kaleoInstanceTokenId,
				kaleoTimerId, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KaleoTimerInstanceToken fetchByKITI_KTI_Last(
		long kaleoInstanceTokenId, long kaleoTimerId) throws SystemException {
		return fetchByKITI_KTI_Last(kaleoInstanceTokenId, kaleoTimerId, null);
	}
	...
	public KaleoTimerInstanceToken fetchByKITI_KTI_Last(
		long kaleoInstanceTokenId, long kaleoTimerId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByKITI_KTI(kaleoInstanceTokenId, kaleoTimerId);

		List<KaleoTimerInstanceToken> list = findByKITI_KTI(kaleoInstanceTokenId,
				kaleoTimerId, count - 1, count, orderByComparator);
	...
	/**
	 * Removes all the kaleo timer instance tokens where kaleoInstanceTokenId = &#63; and kaleoTimerId = &#63; from the database.
	 *
	 * @param kaleoInstanceTokenId the kaleo instance token ID
	 * @param kaleoTimerId the kaleo timer ID
	 * @throws SystemException if a system exception occurred
	...
	public void removeByKITI_KTI(long kaleoInstanceTokenId, long kaleoTimerId)
		throws SystemException {
		for (KaleoTimerInstanceToken kaleoTimerInstanceToken : findByKITI_KTI(
				kaleoInstanceTokenId, kaleoTimerId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(kaleoTimerInstanceToken);
		}
	}
	...
	/**
	 * Returns the first kaleo timer instance token in the default ordered set defined by {@link KaleoTimerInstanceTokenModelImpl#ORDER_BY_JPQL} where kaleoInstanceTokenId = &#63; and completed = &#63;.
	 *
	 * @param kaleoInstanceTokenId the kaleo instance token ID
	 * @param completed the completed
	 * @return the first matching kaleo timer instance token
	...
	public KaleoTimerInstanceToken findByKITI_C_First(
		long kaleoInstanceTokenId, boolean completed)
		throws NoSuchTimerInstanceTokenException, SystemException {
		return findByKITI_C_First(kaleoInstanceTokenId, completed, null);
	}
	...
	public KaleoTimerInstanceToken fetchByKITI_C_First(
		long kaleoInstanceTokenId, boolean completed) throws SystemException {
		return fetchByKITI_C_First(kaleoInstanceTokenId, completed, null);
	}
	...
	/**
	 * Returns the last kaleo timer instance token in the default ordered set defined by {@link KaleoTimerInstanceTokenModelImpl#ORDER_BY_JPQL} where kaleoInstanceTokenId = &#63; and completed = &#63;.
	 *
	 * @param kaleoInstanceTokenId the kaleo instance token ID
	 * @param completed the completed
	 * @return the last matching kaleo timer instance token
	...
	public KaleoTimerInstanceToken findByKITI_C_Last(
		long kaleoInstanceTokenId, boolean completed)
		throws NoSuchTimerInstanceTokenException, SystemException {
		return findByKITI_C_Last(kaleoInstanceTokenId, completed, null);
	}
	...
	public KaleoTimerInstanceToken fetchByKITI_C_Last(
		long kaleoInstanceTokenId, boolean completed) throws SystemException {
		return fetchByKITI_C_Last(kaleoInstanceTokenId, completed, null);
	}
	...
	/**
	 * Returns the first kaleo timer instance token in the default ordered set defined by {@link KaleoTimerInstanceTokenModelImpl#ORDER_BY_JPQL} where kaleoInstanceTokenId = &#63; and completed = &#63; and blocking = &#63;.
	 *
	 * @param kaleoInstanceTokenId the kaleo instance token ID
	 * @param completed the completed
	 * @param blocking the blocking
	...
	public KaleoTimerInstanceToken findByKITI_C_B_First(
		long kaleoInstanceTokenId, boolean completed, boolean blocking)
		throws NoSuchTimerInstanceTokenException, SystemException {
		return findByKITI_C_B_First(kaleoInstanceTokenId, completed, blocking,
			null);
	}
	...
	public KaleoTimerInstanceToken fetchByKITI_C_B_First(
		long kaleoInstanceTokenId, boolean completed, boolean blocking)
		throws SystemException {
		return fetchByKITI_C_B_First(kaleoInstanceTokenId, completed, blocking,
			null);
	}
	...
	/**
	 * Returns the last kaleo timer instance token in the default ordered set defined by {@link KaleoTimerInstanceTokenModelImpl#ORDER_BY_JPQL} where kaleoInstanceTokenId = &#63; and completed = &#63; and blocking = &#63;.
	 *
	 * @param kaleoInstanceTokenId the kaleo instance token ID
	 * @param completed the completed
	 * @param blocking the blocking
	...
	public KaleoTimerInstanceToken findByKITI_C_B_Last(
		long kaleoInstanceTokenId, boolean completed, boolean blocking)
		throws NoSuchTimerInstanceTokenException, SystemException {
		return findByKITI_C_B_Last(kaleoInstanceTokenId, completed, blocking,
			null);
	}
	...
	public KaleoTimerInstanceToken fetchByKITI_C_B_Last(
		long kaleoInstanceTokenId, boolean completed, boolean blocking)
		throws SystemException {
		return fetchByKITI_C_B_Last(kaleoInstanceTokenId, completed, blocking,
			null);
	}
