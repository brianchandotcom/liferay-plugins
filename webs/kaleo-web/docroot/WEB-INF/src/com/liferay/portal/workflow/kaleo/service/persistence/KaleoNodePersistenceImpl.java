...
public class KaleoNodePersistenceImpl extends BasePersistenceImpl<KaleoNode>
	...
	/**
	 * Returns the first kaleo node in the default ordered set defined by {@link KaleoNodeModelImpl#ORDER_BY_JPQL} where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	/**
	 * Returns the last kaleo node in the default ordered set defined by {@link KaleoNodeModelImpl#ORDER_BY_JPQL} where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	/**
	 * Returns the first kaleo node in the default ordered set defined by {@link KaleoNodeModelImpl#ORDER_BY_JPQL} where kaleoDefinitionId = &#63;.
	 *
	 * @param kaleoDefinitionId the kaleo definition ID
	 * @return the first matching kaleo node
	 * @throws com.liferay.portal.workflow.kaleo.NoSuchNodeException if a matching kaleo node could not be found
	...
	/**
	 * Returns the last kaleo node in the default ordered set defined by {@link KaleoNodeModelImpl#ORDER_BY_JPQL} where kaleoDefinitionId = &#63;.
	 *
	 * @param kaleoDefinitionId the kaleo definition ID
	 * @return the last matching kaleo node
	 * @throws com.liferay.portal.workflow.kaleo.NoSuchNodeException if a matching kaleo node could not be found
	...
	/**
	 * Returns the first kaleo node in the default ordered set defined by {@link KaleoNodeModelImpl#ORDER_BY_JPQL} where companyId = &#63; and kaleoDefinitionId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param kaleoDefinitionId the kaleo definition ID
	 * @return the first matching kaleo node
	...
	public KaleoNode findByC_KDI_First(long companyId, long kaleoDefinitionId)
		throws NoSuchNodeException, SystemException {
		return findByC_KDI_First(companyId, kaleoDefinitionId, null);
	}
	...
	public KaleoNode fetchByC_KDI_First(long companyId, long kaleoDefinitionId)
		throws SystemException {
		return fetchByC_KDI_First(companyId, kaleoDefinitionId, null);
	}
	...
	/**
	 * Returns the last kaleo node in the default ordered set defined by {@link KaleoNodeModelImpl#ORDER_BY_JPQL} where companyId = &#63; and kaleoDefinitionId = &#63;.
	 *
	 * @param companyId the company ID
	 * @param kaleoDefinitionId the kaleo definition ID
	 * @return the last matching kaleo node
	...
	public KaleoNode findByC_KDI_Last(long companyId, long kaleoDefinitionId)
		throws NoSuchNodeException, SystemException {
		return findByC_KDI_Last(companyId, kaleoDefinitionId, null);
	}
	...
	public KaleoNode fetchByC_KDI_Last(long companyId, long kaleoDefinitionId)
		throws SystemException {
		return fetchByC_KDI_Last(companyId, kaleoDefinitionId, null);
	}
		...
		if (list == null) {
			...
			try {
				...
				if (orderByComparator != null) {
					...
					sql = _SQL_GETKALEOACTIONS;

					if (pagination) {
						sql = sql.concat(com.liferay.portal.workflow.kaleo.model.impl.KaleoActionModelImpl.ORDER_BY_SQL);
					}
				}
	...
	public int getKaleoActionsSize(long pk) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_GET_KALEOACTIONS_SIZE,
					finderArgs);
	...
	public boolean containsKaleoAction(long pk, long kaleoActionPK)
		...
		if (value == null) {
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_CONTAINS_KALEOACTION,
					finderArgs);
		...
		if (list == null) {
			...
			try {
				...
				if (orderByComparator != null) {
					...
					sql = _SQL_GETKALEOTRANSITIONS;

					if (pagination) {
						sql = sql.concat(com.liferay.portal.workflow.kaleo.model.impl.KaleoTransitionModelImpl.ORDER_BY_SQL);
					}
				}
	...
	public int getKaleoTransitionsSize(long pk) throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_GET_KALEOTRANSITIONS_SIZE,
					finderArgs);
	...
	public boolean containsKaleoTransition(long pk, long kaleoTransitionPK)
		...
		if (value == null) {
			try {
				...
				FinderCacheUtil.removeResult(FINDER_PATH_CONTAINS_KALEOTRANSITION,
					finderArgs);
