...
public class KaleoTaskAssignmentInstancePersistenceImpl
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ACN_ACP = new FinderPath(KaleoTaskAssignmentInstanceModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTaskAssignmentInstanceModelImpl.FINDER_CACHE_ENABLED,
			KaleoTaskAssignmentInstanceImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByACN_ACP",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACN_ACP =
		new FinderPath(KaleoTaskAssignmentInstanceModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTaskAssignmentInstanceModelImpl.FINDER_CACHE_ENABLED,
			KaleoTaskAssignmentInstanceImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByACN_ACP",
			new String[] { String.class.getName(), Long.class.getName() },
			KaleoTaskAssignmentInstanceModelImpl.ASSIGNEECLASSNAME_COLUMN_BITMASK |
			KaleoTaskAssignmentInstanceModelImpl.ASSIGNEECLASSPK_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ACN_ACP = new FinderPath(KaleoTaskAssignmentInstanceModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTaskAssignmentInstanceModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByACN_ACP",
			new String[] { String.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<KaleoTaskAssignmentInstance> findByACN_ACP(
	...
	public List<KaleoTaskAssignmentInstance> findByACN_ACP(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACN_ACP;
			finderArgs = new Object[] { assigneeClassName, assigneeClassPK };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_ACN_ACP;
			finderArgs = new Object[] {
	 ...
	 */
	@Override
	public KaleoTaskAssignmentInstance findByACN_ACP_First(
		String assigneeClassName, long assigneeClassPK,
		OrderByComparator<KaleoTaskAssignmentInstance> orderByComparator)
		throws NoSuchTaskAssignmentInstanceException {
		KaleoTaskAssignmentInstance kaleoTaskAssignmentInstance = fetchByACN_ACP_First(assigneeClassName,
	 ...
	 */
	@Override
	public KaleoTaskAssignmentInstance fetchByACN_ACP_First(
		String assigneeClassName, long assigneeClassPK,
		OrderByComparator<KaleoTaskAssignmentInstance> orderByComparator) {
		List<KaleoTaskAssignmentInstance> list = findByACN_ACP(assigneeClassName,
	 ...
	 */
	@Override
	public KaleoTaskAssignmentInstance findByACN_ACP_Last(
		String assigneeClassName, long assigneeClassPK,
		OrderByComparator<KaleoTaskAssignmentInstance> orderByComparator)
		throws NoSuchTaskAssignmentInstanceException {
		KaleoTaskAssignmentInstance kaleoTaskAssignmentInstance = fetchByACN_ACP_Last(assigneeClassName,
				assigneeClassPK, orderByComparator);
	 ...
	 */
	@Override
	public KaleoTaskAssignmentInstance fetchByACN_ACP_Last(
		String assigneeClassName, long assigneeClassPK,
		OrderByComparator<KaleoTaskAssignmentInstance> orderByComparator) {
	 ...
	 */
	@Override
	public KaleoTaskAssignmentInstance[] findByACN_ACP_PrevAndNext(
		long kaleoTaskAssignmentInstanceId, String assigneeClassName,
		...
		try {
			...
			array[0] = getByACN_ACP_PrevAndNext(session,
					kaleoTaskAssignmentInstance, assigneeClassName,
					assigneeClassPK, orderByComparator, true);

			array[1] = kaleoTaskAssignmentInstance;

			array[2] = getByACN_ACP_PrevAndNext(session,
					kaleoTaskAssignmentInstance, assigneeClassName,
	...
	protected KaleoTaskAssignmentInstance getByACN_ACP_PrevAndNext(
		Session session,
		KaleoTaskAssignmentInstance kaleoTaskAssignmentInstance,
		String assigneeClassName, long assigneeClassPK,
		OrderByComparator<KaleoTaskAssignmentInstance> orderByComparator,
	...
	public void removeByACN_ACP(String assigneeClassName, long assigneeClassPK) {
		for (KaleoTaskAssignmentInstance kaleoTaskAssignmentInstance : findByACN_ACP(
	...
	public int countByACN_ACP(String assigneeClassName, long assigneeClassPK) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_ACN_ACP;
	...
	private static final String _FINDER_COLUMN_ACN_ACP_ASSIGNEECLASSNAME_1 = "kaleoTaskAssignmentInstance.assigneeClassName IS NULL AND ";
	private static final String _FINDER_COLUMN_ACN_ACP_ASSIGNEECLASSNAME_2 = "kaleoTaskAssignmentInstance.assigneeClassName = ? AND ";
	private static final String _FINDER_COLUMN_ACN_ACP_ASSIGNEECLASSNAME_3 = "(kaleoTaskAssignmentInstance.assigneeClassName IS NULL OR kaleoTaskAssignmentInstance.assigneeClassName = '') AND ";
	private static final String _FINDER_COLUMN_ACN_ACP_ASSIGNEECLASSPK_2 = "kaleoTaskAssignmentInstance.assigneeClassPK = ?";
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_ACP_G = new FinderPath(KaleoTaskAssignmentInstanceModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTaskAssignmentInstanceModelImpl.FINDER_CACHE_ENABLED,
			KaleoTaskAssignmentInstanceImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByACP_G",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACP_G = new FinderPath(KaleoTaskAssignmentInstanceModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTaskAssignmentInstanceModelImpl.FINDER_CACHE_ENABLED,
			KaleoTaskAssignmentInstanceImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByACP_G",
			new String[] { Long.class.getName(), Long.class.getName() },
			KaleoTaskAssignmentInstanceModelImpl.ASSIGNEECLASSPK_COLUMN_BITMASK |
			KaleoTaskAssignmentInstanceModelImpl.GROUPID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_ACP_G = new FinderPath(KaleoTaskAssignmentInstanceModelImpl.ENTITY_CACHE_ENABLED,
			KaleoTaskAssignmentInstanceModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByACP_G",
			new String[] { Long.class.getName(), Long.class.getName() });
	...
	/**
	 * Returns all the kaleo task assignment instances where assigneeClassPK = &#63; and groupId = &#63;.
	 *
	 * @param assigneeClassPK the assignee class p k
	 ...
	 */
	@Override
	public List<KaleoTaskAssignmentInstance> findByACP_G(long assigneeClassPK,
		long groupId) {
		return findByACP_G(assigneeClassPK, groupId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the kaleo task assignment instances where assigneeClassPK = &#63; and groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portal.workflow.kaleo.model.impl.KaleoTaskAssignmentInstanceModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<KaleoTaskAssignmentInstance> findByACP_G(long assigneeClassPK,
		...
		return findByACP_G(assigneeClassPK, groupId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the kaleo task assignment instances where assigneeClassPK = &#63; and groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.portal.workflow.kaleo.model.impl.KaleoTaskAssignmentInstanceModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<KaleoTaskAssignmentInstance> findByACP_G(long assigneeClassPK,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACP_G;
			finderArgs = new Object[] { assigneeClassPK, groupId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_ACP_G;
			finderArgs = new Object[] {
					assigneeClassPK, groupId,
		...
		if ((list != null) && !list.isEmpty()) {
			for (KaleoTaskAssignmentInstance kaleoTaskAssignmentInstance : list) {
				if ((assigneeClassPK != kaleoTaskAssignmentInstance.getAssigneeClassPK()) ||
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_ACP_G_ASSIGNEECLASSPK_2);

			query.append(_FINDER_COLUMN_ACP_G_GROUPID_2);
	...
	/**
	 * Returns the first kaleo task assignment instance in the ordered set where assigneeClassPK = &#63; and groupId = &#63;.
	 *
	 * @param assigneeClassPK the assignee class p k
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public KaleoTaskAssignmentInstance findByACP_G_First(long assigneeClassPK,
		long groupId,
		OrderByComparator<KaleoTaskAssignmentInstance> orderByComparator)
		throws NoSuchTaskAssignmentInstanceException {
		KaleoTaskAssignmentInstance kaleoTaskAssignmentInstance = fetchByACP_G_First(assigneeClassPK,
	 ...
	 */
	@Override
	public KaleoTaskAssignmentInstance fetchByACP_G_First(
		long assigneeClassPK, long groupId,
		OrderByComparator<KaleoTaskAssignmentInstance> orderByComparator) {
		List<KaleoTaskAssignmentInstance> list = findByACP_G(assigneeClassPK,
	...
	/**
	 * Returns the last kaleo task assignment instance in the ordered set where assigneeClassPK = &#63; and groupId = &#63;.
	 *
	 * @param assigneeClassPK the assignee class p k
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public KaleoTaskAssignmentInstance findByACP_G_Last(long assigneeClassPK,
		long groupId,
		OrderByComparator<KaleoTaskAssignmentInstance> orderByComparator)
		throws NoSuchTaskAssignmentInstanceException {
		KaleoTaskAssignmentInstance kaleoTaskAssignmentInstance = fetchByACP_G_Last(assigneeClassPK,
				groupId, orderByComparator);
	 ...
	 */
	@Override
	public KaleoTaskAssignmentInstance fetchByACP_G_Last(long assigneeClassPK,
		long groupId,
		OrderByComparator<KaleoTaskAssignmentInstance> orderByComparator) {
		int count = countByACP_G(assigneeClassPK, groupId);
	...
	/**
	 * Returns the kaleo task assignment instances before and after the current kaleo task assignment instance in the ordered set where assigneeClassPK = &#63; and groupId = &#63;.
	 *
	 * @param kaleoTaskAssignmentInstanceId the primary key of the current kaleo task assignment instance
	 * @param assigneeClassPK the assignee class p k
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public KaleoTaskAssignmentInstance[] findByACP_G_PrevAndNext(
		long kaleoTaskAssignmentInstanceId, long assigneeClassPK, long groupId,
		OrderByComparator<KaleoTaskAssignmentInstance> orderByComparator)
		throws NoSuchTaskAssignmentInstanceException {
		KaleoTaskAssignmentInstance kaleoTaskAssignmentInstance = findByPrimaryKey(kaleoTaskAssignmentInstanceId);
		...
		try {
			...
			array[0] = getByACP_G_PrevAndNext(session,
					kaleoTaskAssignmentInstance, assigneeClassPK, groupId,
					orderByComparator, true);

			array[1] = kaleoTaskAssignmentInstance;

			array[2] = getByACP_G_PrevAndNext(session,
					kaleoTaskAssignmentInstance, assigneeClassPK, groupId,
					orderByComparator, false);
	...
	protected KaleoTaskAssignmentInstance getByACP_G_PrevAndNext(
		Session session,
		KaleoTaskAssignmentInstance kaleoTaskAssignmentInstance,
		long assigneeClassPK, long groupId,
		OrderByComparator<KaleoTaskAssignmentInstance> orderByComparator,
	...
	/**
	 * Removes all the kaleo task assignment instances where assigneeClassPK = &#63; and groupId = &#63; from the database.
	 *
	 * @param assigneeClassPK the assignee class p k
	 * @param groupId the group ID
	 */
	@Override
	public void removeByACP_G(long assigneeClassPK, long groupId) {
		for (KaleoTaskAssignmentInstance kaleoTaskAssignmentInstance : findByACP_G(
				assigneeClassPK, groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(kaleoTaskAssignmentInstance);
		}
	}
	...
	/**
	 * Returns the number of kaleo task assignment instances where assigneeClassPK = &#63; and groupId = &#63;.
	 *
	 * @param assigneeClassPK the assignee class p k
	 * @param groupId the group ID
	 * @return the number of matching kaleo task assignment instances
	 */
	@Override
	public int countByACP_G(long assigneeClassPK, long groupId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_ACP_G;

		Object[] finderArgs = new Object[] { assigneeClassPK, groupId };
	...
	private static final String _FINDER_COLUMN_ACP_G_ASSIGNEECLASSPK_2 = "kaleoTaskAssignmentInstance.assigneeClassPK = ? AND ";
	private static final String _FINDER_COLUMN_ACP_G_GROUPID_2 = "kaleoTaskAssignmentInstance.groupId = ?";
	...
	public KaleoTaskAssignmentInstance updateImpl(
		...
		if (isNew ||
			...
			if ((kaleoTaskAssignmentInstanceModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACN_ACP.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						kaleoTaskAssignmentInstanceModelImpl.getOriginalAssigneeClassName(),
						kaleoTaskAssignmentInstanceModelImpl.getOriginalAssigneeClassPK()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_ACN_ACP, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACN_ACP,
					args);
			...
			if ((kaleoTaskAssignmentInstanceModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACP_G.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						kaleoTaskAssignmentInstanceModelImpl.getOriginalAssigneeClassPK(),
						kaleoTaskAssignmentInstanceModelImpl.getOriginalGroupId()
					};

				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_ACP_G, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_ACP_G,
					args);
