...
public class KaleoDefinitionPersistenceImpl extends BasePersistenceImpl<KaleoDefinition>
	...
	/**
	 * Returns the first kaleo definition in the default ordered set defined by {@link KaleoDefinitionModelImpl#ORDER_BY_JPQL} where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	/**
	 * Returns the last kaleo definition in the default ordered set defined by {@link KaleoDefinitionModelImpl#ORDER_BY_JPQL} where companyId = &#63;.
	 *
	 * @param companyId the company ID
	...
	/**
	 * Returns the first kaleo definition in the default ordered set defined by {@link KaleoDefinitionModelImpl#ORDER_BY_JPQL} where companyId = &#63; and name = &#63;.
	 *
	 * @param companyId the company ID
	 * @param name the name
	 * @return the first matching kaleo definition
	...
	/**
	 * Returns the last kaleo definition in the default ordered set defined by {@link KaleoDefinitionModelImpl#ORDER_BY_JPQL} where companyId = &#63; and name = &#63;.
	 *
	 * @param companyId the company ID
	 * @param name the name
	 * @return the last matching kaleo definition
	...
	/**
	 * Returns the first kaleo definition in the default ordered set defined by {@link KaleoDefinitionModelImpl#ORDER_BY_JPQL} where companyId = &#63; and active = &#63;.
	 *
	 * @param companyId the company ID
	 * @param active the active
	 * @return the first matching kaleo definition
	...
	public KaleoDefinition findByC_A_First(long companyId, boolean active)
		throws NoSuchDefinitionException, SystemException {
		return findByC_A_First(companyId, active, null);
	}
	...
	public KaleoDefinition fetchByC_A_First(long companyId, boolean active)
		throws SystemException {
		return fetchByC_A_First(companyId, active, null);
	}
	...
	/**
	 * Returns the last kaleo definition in the default ordered set defined by {@link KaleoDefinitionModelImpl#ORDER_BY_JPQL} where companyId = &#63; and active = &#63;.
	 *
	 * @param companyId the company ID
	 * @param active the active
	 * @return the last matching kaleo definition
	...
	public KaleoDefinition findByC_A_Last(long companyId, boolean active)
		throws NoSuchDefinitionException, SystemException {
		return findByC_A_Last(companyId, active, null);
	}
	...
	public KaleoDefinition fetchByC_A_Last(long companyId, boolean active)
		throws SystemException {
		return fetchByC_A_Last(companyId, active, null);
	}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_N_V = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
			KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED,
			KaleoDefinitionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_N_V",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_N_V = new FinderPath(KaleoDefinitionModelImpl.ENTITY_CACHE_ENABLED,
			KaleoDefinitionModelImpl.FINDER_CACHE_ENABLED,
			KaleoDefinitionImpl.class,
	...
	/**
	 * Returns an ordered range of all the kaleo definitions where companyId = &#63; and name = &#63; and version = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. When orderByComparator is specified, the query will include the given ORDER BY logic. When orderByComparator is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), the query will include the default ORDER BY logic from KaleoDefinitionModelImpl. If both orderByComparator and pagination are absent, for performance reason, the query will not have a ORDER BY clause, on returning the result set will be sorted in portal side by PK ASC order.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	protected List<KaleoDefinition> findByC_N_V(long companyId, String name,
	...
	/**
	 * Returns the first kaleo definition in the default ordered set defined by {@link KaleoDefinitionModelImpl#ORDER_BY_JPQL} where companyId = &#63; and name = &#63; and version = &#63;.
	 *
	 * @param companyId the company ID
	 * @param name the name
	 * @param version the version
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KaleoDefinition findByC_N_V_First(long companyId, String name,
		int version) throws NoSuchDefinitionException, SystemException {
		return findByC_N_V_First(companyId, name, version, null);
	}

	/**
	 * Returns the first kaleo definition in the ordered set where companyId = &#63; and name = &#63; and version = &#63;.
	 *
	 * @param companyId the company ID
	 * @param name the name
	 * @param version the version
	...
	public KaleoDefinition findByC_N_V_First(long companyId, String name,
		...
		throws NoSuchDefinitionException, SystemException {
		KaleoDefinition kaleoDefinition = fetchByC_N_V_First(companyId, name,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KaleoDefinition fetchByC_N_V_First(long companyId, String name,
		int version) throws SystemException {
		return fetchByC_N_V_First(companyId, name, version, null);
	}
	...
	public KaleoDefinition fetchByC_N_V_First(long companyId, String name,
		int version, OrderByComparator orderByComparator)
		throws SystemException {
		List<KaleoDefinition> list = findByC_N_V(companyId, name, version, 0,
				1, orderByComparator);
	...
	/**
	 * Returns the last kaleo definition in the default ordered set defined by {@link KaleoDefinitionModelImpl#ORDER_BY_JPQL} where companyId = &#63; and name = &#63; and version = &#63;.
	 *
	 * @param companyId the company ID
	 * @param name the name
	 * @param version the version
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KaleoDefinition findByC_N_V_Last(long companyId, String name,
		int version) throws NoSuchDefinitionException, SystemException {
		return findByC_N_V_Last(companyId, name, version, null);
	}

	/**
	 * Returns the last kaleo definition in the ordered set where companyId = &#63; and name = &#63; and version = &#63;.
	 *
	 * @param companyId the company ID
	 * @param name the name
	 * @param version the version
	...
	public KaleoDefinition findByC_N_V_Last(long companyId, String name,
		int version, OrderByComparator orderByComparator)
		throws NoSuchDefinitionException, SystemException {
		KaleoDefinition kaleoDefinition = fetchByC_N_V_Last(companyId, name,
				version, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public KaleoDefinition fetchByC_N_V_Last(long companyId, String name,
		int version) throws SystemException {
		return fetchByC_N_V_Last(companyId, name, version, null);
	}
	...
	public KaleoDefinition fetchByC_N_V_Last(long companyId, String name,
		...
		List<KaleoDefinition> list = findByC_N_V(companyId, name, version,
	...
	/**
	 * Removes all the kaleo definitions where companyId = &#63; and name = &#63; and version = &#63; from the database.
	 *
	 * @param companyId the company ID
	 * @param name the name
	 * @param version the version
	...
	public void removeByC_N_V(long companyId, String name, int version)
		throws SystemException {
		for (KaleoDefinition kaleoDefinition : findByC_N_V(companyId, name,
	...
	/**
	 * Returns the first kaleo definition in the default ordered set defined by {@link KaleoDefinitionModelImpl#ORDER_BY_JPQL} where companyId = &#63; and name = &#63; and active = &#63;.
	 *
	 * @param companyId the company ID
	 * @param name the name
	 * @param active the active
	...
	public KaleoDefinition findByC_N_A_First(long companyId, String name,
		boolean active) throws NoSuchDefinitionException, SystemException {
	...
	/**
	 * Returns the last kaleo definition in the default ordered set defined by {@link KaleoDefinitionModelImpl#ORDER_BY_JPQL} where companyId = &#63; and name = &#63; and active = &#63;.
	 *
	 * @param companyId the company ID
	 * @param name the name
	 * @param active the active
