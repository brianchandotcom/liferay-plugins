...
public class SyncDLObjectPersistenceImpl extends BasePersistenceImpl<SyncDLObject>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_T_V = new FinderPath(SyncDLObjectModelImpl.ENTITY_CACHE_ENABLED,
			SyncDLObjectModelImpl.FINDER_CACHE_ENABLED, SyncDLObjectImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByT_V",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_T_V = new FinderPath(SyncDLObjectModelImpl.ENTITY_CACHE_ENABLED,
			SyncDLObjectModelImpl.FINDER_CACHE_ENABLED, SyncDLObjectImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByT_V",
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_T_V = new FinderPath(SyncDLObjectModelImpl.ENTITY_CACHE_ENABLED,
			SyncDLObjectModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByT_V",
			new String[] { String.class.getName(), String.class.getName() });

	/**
	 * Returns all the sync d l objects where type = &#63; and version = &#63;.
	 *
	 * @param type the type
	 ...
	 */
	@Override
	public List<SyncDLObject> findByT_V(String type, String version) {
		return findByT_V(type, version, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}

	/**
	 * Returns a range of all the sync d l objects where type = &#63; and version = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<SyncDLObject> findByT_V(String type, String version, int start,
		int end) {
		return findByT_V(type, version, start, end, null);
	}

	/**
	 * Returns an ordered range of all the sync d l objects where type = &#63; and version = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link com.liferay.sync.model.impl.SyncDLObjectModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<SyncDLObject> findByT_V(String type, String version, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_T_V;
			finderArgs = new Object[] { type, version };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_T_V;
		...
		if ((list != null) && !list.isEmpty()) {
			for (SyncDLObject syncDLObject : list) {
				if (!Validator.equals(type, syncDLObject.getType()) ||
						!Validator.equals(version, syncDLObject.getVersion())) {
					list = null;
		...
		if (list == null) {
			...
			if (type == null) {
				query.append(_FINDER_COLUMN_T_V_TYPE_1);
			}
			else if (type.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_T_V_TYPE_3);
			}
			else {
				bindType = true;

				query.append(_FINDER_COLUMN_T_V_TYPE_2);
			}
	...
	/**
	 * Returns the first sync d l object in the ordered set where type = &#63; and version = &#63;.
	 *
	 * @param type the type
	 * @param version the version
	 ...
	 */
	@Override
	public SyncDLObject findByT_V_First(String type, String version,
		OrderByComparator<SyncDLObject> orderByComparator)
		throws NoSuchDLObjectException {
		SyncDLObject syncDLObject = fetchByT_V_First(type, version,
				orderByComparator);
	 ...
	 */
	@Override
	public SyncDLObject fetchByT_V_First(String type, String version,
		OrderByComparator<SyncDLObject> orderByComparator) {
		List<SyncDLObject> list = findByT_V(type, version, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last sync d l object in the ordered set where type = &#63; and version = &#63;.
	 *
	 * @param type the type
	 * @param version the version
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public SyncDLObject findByT_V_Last(String type, String version,
		OrderByComparator<SyncDLObject> orderByComparator)
		throws NoSuchDLObjectException {
		SyncDLObject syncDLObject = fetchByT_V_Last(type, version,
				orderByComparator);
	 ...
	 */
	@Override
	public SyncDLObject fetchByT_V_Last(String type, String version,
		OrderByComparator<SyncDLObject> orderByComparator) {
		int count = countByT_V(type, version);

		if (count == 0) {
			return null;
		}

		List<SyncDLObject> list = findByT_V(type, version, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the sync d l objects before and after the current sync d l object in the ordered set where type = &#63; and version = &#63;.
	 *
	 ...
	 */
	@Override
	public SyncDLObject[] findByT_V_PrevAndNext(long syncDLObjectId,
		...
		try {
			...
			array[0] = getByT_V_PrevAndNext(session, syncDLObject, type,
					version, orderByComparator, true);

			array[1] = syncDLObject;

			array[2] = getByT_V_PrevAndNext(session, syncDLObject, type,
	...
	protected SyncDLObject getByT_V_PrevAndNext(Session session,
		SyncDLObject syncDLObject, String type, String version,
	...
	/**
	 * Removes all the sync d l objects where type = &#63; and version = &#63; from the database.
	 *
	 * @param type the type
	 * @param version the version
	 */
	@Override
	public void removeByT_V(String type, String version) {
		for (SyncDLObject syncDLObject : findByT_V(type, version,
	...
	/**
	 * Returns the number of sync d l objects where type = &#63; and version = &#63;.
	 *
	 * @param type the type
	 * @param version the version
	 ...
	 */
	@Override
	public int countByT_V(String type, String version) {
	...
	private static final String _FINDER_COLUMN_T_V_TYPE_1 = "syncDLObject.type IS NULL AND ";
	private static final String _FINDER_COLUMN_T_V_TYPE_2 = "syncDLObject.type = ? AND ";
	private static final String _FINDER_COLUMN_T_V_TYPE_3 = "(syncDLObject.type IS NULL OR syncDLObject.type = '') AND ";
	private static final String _FINDER_COLUMN_T_V_VERSION_1 = "syncDLObject.version IS NULL";
	private static final String _FINDER_COLUMN_T_V_VERSION_2 = "syncDLObject.version = ?";
	private static final String _FINDER_COLUMN_T_V_VERSION_3 = "(syncDLObject.version IS NULL OR syncDLObject.version = '')";
	...
	public SyncDLObject updateImpl(
		...
		if (isNew || !SyncDLObjectModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((syncDLObjectModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_T_V.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						syncDLObjectModelImpl.getOriginalType(),
				...
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_T_V,
					args);
