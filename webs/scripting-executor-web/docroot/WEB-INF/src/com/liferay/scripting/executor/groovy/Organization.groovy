...
class Organization {
	...
	static com.liferay.portal.model.Organization fetchOrganization(
		ScriptingContext scriptingContext, String name) {
	...
	void create(ScriptingContext scriptingContext) {
		...
		liferayOrganization = fetchOrganization(scriptingContext, name);
