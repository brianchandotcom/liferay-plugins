...
/**
 * Provides the remote service utility for LiferayScreensDDLRecord. This utility wraps
 * {@link com.liferay.screens.service.impl.LiferayScreensDDLRecordServiceImpl} and is the
 ...
 * @generated
 */
public class LiferayScreensDDLRecordServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.screens.service.impl.LiferayScreensDDLRecordServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static LiferayScreensDDLRecordService getService() {
		if (_service == null) {
			InvokableService invokableService = (InvokableService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					LiferayScreensDDLRecordService.class.getName());

			if (invokableService instanceof LiferayScreensDDLRecordService) {
				_service = (LiferayScreensDDLRecordService)invokableService;
			}
			else {
				_service = new LiferayScreensDDLRecordServiceClp(invokableService);
			}

			ReferenceRegistry.registerReference(LiferayScreensDDLRecordServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(LiferayScreensDDLRecordService service) {
	}

	private static LiferayScreensDDLRecordService _service;
}