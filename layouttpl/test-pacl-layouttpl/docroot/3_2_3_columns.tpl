<div class="columns-3-2-3" id="main-content" role="main">
		...
		<div class="portlet-layout">
			...
			<div class="aui-w66 portlet-column portlet-column-last" id="column-5">
				$processor.processColumn("column-5", "portlet-column-content portlet-column-content-last")
			</div>
		</div>

		<div class="portlet-layout">
			<div class="aui-w33 portlet-column portlet-column-first" id="column-6">
				$processor.processColumn("column-6", "portlet-column-content portlet-column-content-first")
			</div>

			<div class="aui-w33 portlet-column" id="column-7">
				$processor.processColumn("column-7", "portlet-column-content")
			</div>
	...
	<div id="test">
		...
		<p>
			&#36;serviceLocator.findService('com.liferay.portlet.blogs.service.BlogsEntryLocalService')=

				#set ($result1 = $!serviceLocator.findService('com.liferay.portlet.blogs.service.BlogsEntryLocalService'))

				#if ($!result1.getBeanIdentifier())
					FAILED
				#else
					PASSED
				#end
		...
		<p>
			&#36;serviceLocator.findService('com.liferay.portal.service.GroupLocalService')=
				...
				#set ($result2 = $!serviceLocator.findService('com.liferay.portal.service.GroupLocalService'))

				#if (!$result2.getBeanIdentifier())
					FAILED
				#else
					PASSED
				#end
		...
		<p>
			&#36;portal.getClass().forName('com.liferay.portal.json.JSONFactoryImpl').newInstance()=

				#set ($result3 = $!portal.getClass().forName('com.liferay.portal.json.JSONFactoryImpl').newInstance())
